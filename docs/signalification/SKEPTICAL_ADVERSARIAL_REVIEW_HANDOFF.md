...
3. **Live physical-device E2E matrix** — reachable iPhone and Android Signal proofs are green, including the focused iPhone CLI mission Signal relocation test; iPad remains CoreDevice-unavailable and production-domain live flows remain blocked until producers are enabled.
...
| Phase D physical-device E2E (iPhone/Android/Mac/Python matrix) | reachable iPhone/Android local Signal proofs green; iPad unavailable; live production-domain flows still blocked by flag-OFF producers | hardware + producer activation |
