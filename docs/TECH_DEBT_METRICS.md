...
**Generated at (UTC):** 2026-07-15T10:03:12Z
...
| Top-4 service LOC (CloudSync + Search + UsageAgg + Projection) | 3919 | ≤ 5000 | ≤ 3500 |
...
| Force-unwrap sites (`budgets/force-unwrap-baseline.json`, shrink-only ratchet) | 215 | shrinking | 0 |
...
| `AgentLens/Services/UsageAggregator.swift` | 614 |
