...
**Generated at (UTC):** 2026-06-14T06:05:50Z
...
| `try?` in `AgentLens/Services/` | 812 | ≤ 120 | ≤ 50 |
| Unsafe cast budget (`budgets/unsafe-cast-baseline.json`) | 139 | 0 | 0 |
| Top-4 service LOC (CloudSync + Search + UsageAgg + Projection) | 3654 | ≤ 5000 | ≤ 3500 |
...
| `AgentLens/Services/UsageAggregator.swift` | 597 |
