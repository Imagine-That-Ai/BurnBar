...
| `Task.detached` in `AgentLens/Services/` | 3 | ≤ 10 | 0 |
| `try?` in `AgentLens/Services/` | 5 | ≤ 120 | ≤ 50 |
...
| `AgentLens/Services/UsageAggregator.swift` | 572 |
| `AgentLens/Services/ProjectionPipeline/` | 1590 |
