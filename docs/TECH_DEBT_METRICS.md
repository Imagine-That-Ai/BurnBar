...
**Generated at (UTC):** 2026-05-28T05:48:14Z
...
| Top-4 service LOC (CloudSync + Search + UsageAgg + Projection) | 3184 | ≤ 5000 | ≤ 3500 |
| `functions/src/types.ts` LOC (barrel) | 16 | stable (re-export) | — |
| `functions/src/types/legacy.ts` LOC | 2895 | shrinking (TypeSpec migration) | — |
