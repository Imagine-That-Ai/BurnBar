...
**Generated at (UTC):** 2026-05-30T17:04:20Z
...
| Empty `catch {}` blocks (app + daemon) | 97 | 0 | 0 |
...
| `functions/src/types/legacy.ts` LOC | 2864 | shrinking (TypeSpec migration) | — |
| `functions/src/index.ts` LOC | 109 | modularize | — |
