...
**Generated at (UTC):** 2026-07-10T13:10:33Z
...
| `Task.detached` in `AgentLens/Services/` | 5 | ≤ 10 | 0 |
...
| `@unchecked Sendable` ratchet (assert-zero gate; 63 documented allowlist exceptions) | 0 | 0 | 0 |
| Top-4 service LOC (CloudSync + Search + UsageAgg + Projection) | 3920 | ≤ 5000 | ≤ 3500 |
| `functions/src/types.ts` LOC (barrel) | 8 | stable (re-export) | — |
| `functions/src/types/legacy.ts` LOC | 19 | shrinking (TypeSpec migration) | — |
| `functions/src/index.ts` LOC | 210 | modularize | — |
...
| `AgentLens/Services/UsageAggregator.swift` | 615 |
