...
Kotlin, Go, JavaScript, Rust, Swift, Python, TypeScript, and TSX. A dedicated
Windows x64/ARM64 MSVC workflow now formats, tests, builds, and smoke-tests the
parser; its first green Windows run and a live Windows LSP host remain separate
evidence gates.
...
The presentation suite is now 757/757 after durable project-code store coverage;
the focused chat runtime suite is 24/24; the Rust parser suite is 18/18. The
F1 parity ledger remains the machine-scanned 46-row source/product gate.
