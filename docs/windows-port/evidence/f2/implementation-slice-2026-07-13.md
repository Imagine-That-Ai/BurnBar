...
relative reference paths. Tree-sitter symbol extraction now covers C#,
JavaScript, Rust, Swift, Python, TypeScript, and TSX. Java/Kotlin/Go grammar
coverage and a live Windows LSP host remain separate evidence gates.
...
the focused chat runtime suite is 24/24; the Rust parser suite is 15/15. The
