...
chunks, versioned deterministic 96-dimensional vectors, and checkpoints. A
...
NaturalLanguage/provider embedding quality and AST-aware chunking remain
...
The presentation suite is now 759/759 after durable project-code store and
