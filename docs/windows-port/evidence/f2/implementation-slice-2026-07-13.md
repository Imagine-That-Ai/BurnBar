...
and `3b0a7581f5` (bounded, redacted project context packs), plus the current
Anthropic provider-adapter commit. Their focused tests are included in the
