...
| Chat gateway | `gateway_probe`, `gateway_chat_stream` (Channel SSE, lib.rs taxonomy + 16 MiB cap + UTF-8 boundary handling), `gateway_chat_cancel` | `LocalHttpGatewayHost` loopback proxy |
