...
Browser Computer Use composition, project symbols, and Elder Wand journaling,
and closes the standalone authenticated companion CLI, but does not close every
