...
_(Wave 4 verification pending — target 0/0/pass.)_

| Metric | Baseline | Final |
|---|---:|---:|
| Detekt weighted issues | 3,784 | **924** (in progress) |
| Detekt raw violations | 6,818 | **~1,200** (in progress) |
| ktlint violations | not yet measured at baseline | pending |
