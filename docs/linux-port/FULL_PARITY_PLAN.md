...
`2ad3b2752d`, with the prior 90 frontend test files / 853 passing tests plus
focused mission, shell, and IPv6 adapter regressions. The exact-head ARM64
package currently installed is the preceding `e4f14c4387` receipt and renders
in the unlocked
