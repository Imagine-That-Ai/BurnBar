...
`2ad3b2752d`, with 90 frontend test files / 856 passing tests. The exact-head ARM64
package currently installed is the exact `2ad3b2752d` receipt and renders in
the unlocked
