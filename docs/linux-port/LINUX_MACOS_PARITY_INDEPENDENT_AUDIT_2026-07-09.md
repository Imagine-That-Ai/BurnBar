...
| P-20 | Missions | Full run/task state, approvals, questions, evidence, history, health | List/create/approve is live; mission detail/cancel/history/evidence depth is in the P20 implementation slice | Partial | Medium |
...
| P18/P19/P25/P30/P40 implementation slices | In review | Daemon-authoritative memory, canonical project management, signed update freshness/compatibility, fail-closed pet capability, and daemon-backed privacy consent are implemented in PRs #1671, #1670, #1673, #1674, and #1672 | Merge/rebase onto the release head, then prove installed behavior; first-class quarantine, project delete/reassign, global text expansion, native pet adapters, and destructive privacy/recovery contracts remain separate dependencies |
