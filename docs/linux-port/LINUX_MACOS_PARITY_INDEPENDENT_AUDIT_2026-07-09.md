...
| Current-head source receipt | `linux-source-tests-2026-07-24.json` records **70/70** focused Linux release/evidence contract tests passing at `c567506a10`; the receipt is explicitly non-certifying and covers no product rows. |
