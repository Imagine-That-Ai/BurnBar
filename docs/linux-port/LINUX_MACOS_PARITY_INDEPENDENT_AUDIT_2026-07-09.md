...
| Current source proof | The post-`main` exact-native checkpoint is `22fd7dfad9`. Frontend tests pass at 94 files / 910 tests, Tauri Rust at 133/133, workflow verifier Node tests at 28/28, and Linux Swift verifier Python tests at 18/18; TypeScript, the production-bundle verifier, and fresh Ubuntu ARM64 production builds of the daemon and CLI also pass. The exact DEB build/install and installed hash proof pass: [`evidence/parity-audit-2026-07-10/linux-arm64-current-22fd7dfad9-exact-native-2026-07-20.json`](evidence/parity-audit-2026-07-10/linux-arm64-current-22fd7dfad9-exact-native-2026-07-20.json). |
