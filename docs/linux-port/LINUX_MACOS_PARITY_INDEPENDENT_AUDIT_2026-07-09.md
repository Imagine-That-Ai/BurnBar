...
| Integrated Linux validation | Local integration worktree, current 2026-07-13 | Replayed P07/P11/P13/P14/P16/P17/P19/P20/P21/P22/P23/P24/P25/P27/P28/P30/P31/P35/P39/P40 on the P26 tray/deep-link base: 70 Vitest files / 564 tests, TypeScript, production bundle verification, differential-oracle tests, Tauri Rust 69/69, and the supported SQLCipher-backed daemon chat selector 9/9 passed. This is engineering evidence only, not installed-product certification. |
