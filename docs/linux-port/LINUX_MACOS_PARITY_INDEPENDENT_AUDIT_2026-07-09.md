...
| Current-head source receipt | `linux-source-tests-2026-07-24.json` records **87/87** focused Linux release/evidence and P-39 differential contract tests passing at `488d8d10b6`; the receipt is explicitly non-certifying and covers no product rows. |
