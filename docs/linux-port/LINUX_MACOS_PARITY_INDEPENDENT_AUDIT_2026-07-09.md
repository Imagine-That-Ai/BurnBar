...
The next source slice is now integrated at `f6d3843937`: Linux Insights has a
...
an owner-checked XDG autostart override (`f6d3843937`). Focused verification is
