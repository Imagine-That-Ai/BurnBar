...
| Current source proof | `fc0af729e1` is the current source head. Frontend tests are 877/877, host Tauri Rust is 129/129, and Ubuntu ARM64 media-enabled Rust is 130/130. The current installed shell receipt is non-certifying because its daemon/CLI are reused staged payloads and its manifest is unsigned: [`evidence/parity-audit-2026-07-10/linux-arm64-current-fc0af729e1-ui-staged-daemon-2026-07-20.json`](evidence/parity-audit-2026-07-10/linux-arm64-current-fc0af729e1-ui-staged-daemon-2026-07-20.json). |
...
| Latest VM proof | The current `fc0af729e1` ARM64 DEB is installed in the Ubuntu 24.04.4 GNOME/X11 UTM guest. The non-certifying receipt is [`evidence/parity-audit-2026-07-10/linux-arm64-current-fc0af729e1-ui-staged-daemon-2026-07-20.json`](evidence/parity-audit-2026-07-10/linux-arm64-current-fc0af729e1-ui-staged-daemon-2026-07-20.json). The daemon/CLI are reused staged payloads and the manifest is unsigned; AT-SPI/window/health proof is current for the shell package. |
...
The table's historical packaging row predates the latest UI wave. The authoritative
current source gate is `fc0af729e1`: **91 frontend files / 877 tests**, TypeScript,
production-bundle verification, host Rust 129/129, and Ubuntu ARM64 media Rust
130/130. The account, chat, and memory commits are now installed in the shell
package; the staged daemon/CLI and unsigned manifest remain non-certifying.
