...
`2ad3b2752d`; the latest installed package is bound to that exact source head.
...
- `106b15855b` retains the last good mission snapshot during transient refresh
  ...
  included in the installed `2ad3b2752d` package receipt.
- Source gates pass: 90 frontend files / 856 tests, TypeScript, production
...
- The ARM64 VM validated the supported Swift-less staged-payload path with
  ...
  was then rebuilt with clean fresh daemon and CLI payloads from `2ad3b2752d`
