...
`2ad3b2752d`; the latest installed package is bound to the preceding exact
source head `e4f14c4387`.
...
- `106b15855b` retains the last good mission snapshot during transient refresh
  ...
  newer than the installed `e4f14c4387` package and remain uninstalled proof.
...
- The ARM64 VM validated the supported Swift-less staged-payload path with
  ...
  was then rebuilt with clean fresh daemon and CLI payloads from `e4f14c4387`
  and captured separately in
