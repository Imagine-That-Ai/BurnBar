...
| Integrated Linux validation | Local integration worktree, current 2026-07-13 | Replayed P07/P11/P13/P14/P16/P17/P19/P20/P21/P22/P23/P24/P25/P27/P28/P30/P31/P35/P39/P40 on the P26 tray/deep-link base: 70 Vitest files / 563 tests, TypeScript, production bundle verification, differential-oracle tests, and Tauri Rust 69/69 passed; daemon chat selector built but could not execute because SwiftPM did not embed SQLCipher.framework. This is engineering evidence only, not installed-product certification. |
...
| P07/P11/P13/P14/P16/P17/P18/P19/P20/P22/P25/P27/P30/P31/P40 implementation slices | In review | Checked browser Computer Use panel, 33-provider catalog, daemon-backed onboarding credential setup, exact encrypted chat thread persistence/pagination/export, loaded activity export, fail-closed account/enrollment posture, daemon-authoritative memory, canonical project management, mission detail/cancel/evidence snapshots, bounded database code inspection, signed update freshness/compatibility, native startup/deep-link handoff plus single-instance forwarding, accessibility preference styling, fail-closed pet capability, and daemon-backed privacy consent are implemented in PRs [#1681](https://github.com/Imagine-That-Ai/BurnBar/pull/1681), #1676, #1667, [#1684](https://github.com/Imagine-That-Ai/BurnBar/pull/1684), [#1685](https://github.com/Imagine-That-Ai/BurnBar/pull/1685), #1658, #1671, #1670, #1677, #1680, #1673, #1679, [#1686](https://github.com/Imagine-That-Ai/BurnBar/pull/1686), [#1683](https://github.com/Imagine-That-Ai/BurnBar/pull/1683), #1674, and #1672 | Merge/rebase onto the release head, then prove installed behavior; chat attachments/citations/approvals/options/full-history export/pop-out and remaining backends, activity body replay, normalized provider corpus, OAuth/portal auth, trusted-device mobile execution, first-class quarantine, project delete/reassign, database snapshots/recovery, mission health/history where absent from the contract, freedesktop notification actions/global shortcuts, global text expansion, native pet adapters, and destructive privacy/recovery contracts remain separate dependencies |
