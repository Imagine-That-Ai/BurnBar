...
| Latest VM proof | The prior `90c5bd34ca` ARM64 DEB is installed in the Ubuntu 24.04.4 GNOME/X11 UTM guest. The non-certifying receipt is [`evidence/parity-audit-2026-07-10/linux-arm64-current-90c5bd34ca-ui-staged-daemon-2026-07-20.json`](evidence/parity-audit-2026-07-10/linux-arm64-current-90c5bd34ca-ui-staged-daemon-2026-07-20.json). The newer `fc0af729e1` source wave is not yet installed; the live daemon health/window/AT-SPI facts still apply to the prior package. |
...
130/130. The newer account, chat, and memory commits are source-tested but not
yet installed in the VM receipt.
...
`fc0af729e1`; the latest installed package is the prior `90c5bd34ca` shell
checkpoint, while its daemon/CLI are reused staged payloads. This is a source
and build checkpoint, not a promotion claim:
