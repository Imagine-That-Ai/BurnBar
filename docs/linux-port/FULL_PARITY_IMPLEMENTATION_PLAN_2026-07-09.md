...
> `90fac18c86` and passes **90 frontend files / 853 tests**, TypeScript,
...
Integration head `90fac18c86` passes 90 frontend files / 853 tests, TypeScript,
...
`evidence/parity-audit-2026-07-10/linux-arm64-current-90fac18c86-postinstall-2026-07-19.json`.
