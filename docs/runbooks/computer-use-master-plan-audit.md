...
Remaining work: app-owned Path C still needs the rest of the real device matrix: TextEdit 50/50, deny-region 12/12, direct-download notarization, and `spctl --assess`.
...
- Phase 11 direct-download notarized distribution, TextEdit 50/50, and deny-region matrix. Calculator 50/50 is now proven by `tools/CUClickSmoke`.
