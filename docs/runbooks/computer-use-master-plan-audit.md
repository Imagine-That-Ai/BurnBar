...
Remaining work: app-owned Path C still needs the real device matrix: Calculator 50/50, TextEdit 50/50, deny-region 12/12, direct-download notarization, and `spctl --assess`.
