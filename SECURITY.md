...
OpenBurnBar supports the current `main` branch and the version declared in the repo metadata (`1.0.4` in this source release). Older commits may contain known issues and may not receive fixes.
