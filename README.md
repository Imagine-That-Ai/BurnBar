<div align="center">
  ...
  **Status:** Commercial launch candidate — macOS `1.0.29` is prepared for Mac App Store review and ships as a Developer ID notarized direct download; Windows `1.0.32` is the parity release line; iOS `1.0.2` build `82` and the Hosted Quota Sync subscription are in Apple review with manual release enabled.
