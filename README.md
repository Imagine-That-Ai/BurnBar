<div align="center">
  ...
  **Status:** Commercial launch candidate — macOS `1.0.14` is prepared for Mac App Store review and ships as a Developer ID notarized direct download; iOS `1.0.2` and the Hosted Quota Sync subscription are in Apple review with manual release enabled.
