...
final class AgentIdentityRegistry {
    ...
    func refresh(
        ...
        identities = identities.map { existing in
            ...
            case .junie:
                availability = runtimeAvailabilityByID["junie"] ?? existing.availability
            case .openClaude:
                availability = runtimeAvailabilityByID["openclaude"]
                    ?? runtimeAvailabilityByID["open-claude"]
                    ?? existing.availability
            case .omp:
                availability = runtimeAvailabilityByID["omp"]
            ...
            case .fx:
                availability = runtimeAvailabilityByID["fx"]
                    ...
                    ?? existing.availability
            case .muse:
                availability = runtimeAvailabilityByID["muse"]
                    ?? runtimeAvailabilityByID["muse-code"]
                    ?? runtimeAvailabilityByID["meta-muse"]
                    ?? existing.availability
            case .none:
