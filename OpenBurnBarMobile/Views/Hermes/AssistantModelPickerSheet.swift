...
struct AssistantModelPickerSheet: View {
    ...
    private var isCLIRuntime: Bool {
        switch runtime {
        case .codex, .claude, .droid, .forge, .antigravity, .grok, .cursorAgent, .openClaude, .junie: return true
    ...
    private func currentLiveRelayOptions() -> [HermesRuntimeModelOption] {
        ...
        case .codex, .claude, .droid, .forge, .antigravity, .grok, .cursorAgent, .openClaude, .junie: return []
        }
    }
    ...
    private func favoritesGroupIfAny() -> some View {
        ...
        case .codex, .claude, .droid, .forge, .antigravity, .grok, .cursorAgent, .openClaude, .junie:
            EmptyView()
        }
    }
    ...
    private func isFavorited(_ option: AssistantModelOption) -> Bool {
        ...
        case .codex, .claude, .droid, .forge, .antigravity, .grok, .cursorAgent, .openClaude, .junie: return false
        }
    }
    ...
    private var resetButton: some View {
        let hasPreference: Bool = {
            ...
            case .codex, .claude, .droid, .forge, .antigravity, .grok, .cursorAgent, .openClaude, .junie: return cliPreference != nil
            }
        }()
        if hasPreference {
            Button {
    ...
    private var resetLabel: String {
        ...
        case .codex, .claude, .droid, .forge, .antigravity, .grok, .cursorAgent, .openClaude, .junie: return "Clear preference (let the Mac CLI choose)"
        }
    }
    ...
    private func refreshLive() async {
        ...
        case .codex, .claude, .droid, .forge, .antigravity, .grok, .cursorAgent, .openClaude, .junie: break
        }
    }
