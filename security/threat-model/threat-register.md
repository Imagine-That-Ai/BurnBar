...
- **Gap:** .github/dependabot.yml DOES cover the github-actions ecosystem (weekly bump PRs) but Dependabot bumps a mutable tag to a newer tag and does NOT convert refs to SHA pins, so mutable refs persist between bumps — SHA-pin for tamper-resistance.
