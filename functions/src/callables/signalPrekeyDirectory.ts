 ...
 *
 * The pure validators + Firestore-doc builders live in
 * ./signalPrekeyDirectoryValidators.js (split out to keep each module under the
 * per-file line ceiling); this module holds the runtime/Firestore glue.
 */
...
import { safeCloudDocumentID, requireRecordArray, commitBatchedWrites } from "./shared.js";
import {
  parseSignalBase64,
