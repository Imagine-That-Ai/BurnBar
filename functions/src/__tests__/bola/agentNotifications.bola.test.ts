...
export const BOLA_MANIFEST = {
  submitAgentNotificationReply: ["submitAgentNotificationReply rejects cross-user object access"],
} as const;

describe("BOLA — agentNotifications", () => {
  it("submitAgentNotificationReply rejects cross-user object access", async () => {
    const mod = await import("../../../../functions-sync/src/domains/notify/agentNotifications.js");
