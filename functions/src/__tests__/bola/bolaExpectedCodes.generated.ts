...
export const BOLA_EXPECTED_CODES: Record<string, BolaExpectedCode> = {
  ...
  approveLinuxAppCheckDevice: "permission-denied",
  ...
  resolveActiveIrohControllerRoutes: "failed-precondition",
  ...
  revokeLinuxAppCheckDevice: "permission-denied",
  revokePiAgentConnection: "permission-denied",
  revokeProviderAccountDeviceLink: "not-found",
  revokeRemoteMcpClient: "not-found",
  ...
  submitDomainCoreShadowSamples: "not-found",
