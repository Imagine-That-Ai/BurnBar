 ...
 *
 * The flag-day / purge / cap-aggregate suites live in
 * `knowledgeMemoryDedupLifecycle.test.ts`; the shared Firestore double and
 * derivation helpers live in `knowledgeDedupTestHarness.ts`.
 */
