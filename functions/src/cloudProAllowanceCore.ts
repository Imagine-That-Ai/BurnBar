...
export const CLOUD_PRO_INCLUDED_FUSION_SEARCHES_MONTHLY = 100;
export const CLOUD_ULTRA_INCLUDED_FUSION_SEARCHES_MONTHLY = 300;
...
export const CLOUD_PRO_MONTHLY_FUSION_SEARCH_CAP = 1000;
export const CLOUD_ULTRA_MONTHLY_FUSION_SEARCH_CAP = 2000;
