 ...
 * (`OpenBurnBarCore/Sources/OpenBurnBarKernelModels/Resources/catalog.json`), which
 * is not reachable from the functions runtime. Every USD rate that functions code
