...
export const endpointAuthorizationCatalog: EndpointAuthorizationEntry[] = [
  ...
  {
    exportedName: "aggregateCommunityLeaderboards",
    trigger: "scheduled",
  ...
  {
    exportedName: "cleanupStaleCommunityLeaderboards",
    trigger: "scheduled",
    authMethod: "Cloud Scheduler / platform trigger",
    appCheck: "not-applicable",
  ...
  {
    exportedName: "exportLookingGlassBundle",
    trigger: "callable",
    authMethod: "Firebase Auth with callable-level ownership checks",
    appCheck: "required",
    tenantSource: "request.auth.uid",
  ...
  {
    exportedName: "revokeCommunityParticipation",
    trigger: "callable",
    authMethod: "Firebase Auth with callable-level ownership checks",
    appCheck: "required",
    tenantSource: "request.auth.uid",
  ...
  {
    exportedName: "updateCommunityProfile",
    trigger: "callable",
    authMethod: "Firebase Auth with callable-level ownership checks",
    appCheck: "required",
