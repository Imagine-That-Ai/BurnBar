...
const LOWER_TRUST_DESKTOP_POLICY_OVERRIDES = {
  ...
  publishIrohPairingPublicKey: "desktop-trusted-device-step-up",
  publishIrohPairingRecord: "desktop-trusted-device-step-up",
  revokeAllAccess: "desktop-trusted-device-step-up",
  revokeIrohPairingRecord: "desktop-trusted-device-step-up",
...
const LOWER_TRUST_HANDLER_MODULE_OVERRIDES = {
  ...
  publishIrohPairingPublicKey: "callables/phoneControlCallables.ts",
  publishIrohPairingRecord: "callables/phoneControlCallables.ts",
  revokeIrohPairingRecord: "callables/phoneControlCallables.ts",
