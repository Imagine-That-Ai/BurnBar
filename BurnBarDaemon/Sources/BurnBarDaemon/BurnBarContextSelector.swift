...
public enum BurnBarContextSelectorError: Error, LocalizedError {
    ...
    public var errorDescription: String? {
        switch self {
        case .missingTargetPath:
            return "BurnBar context selection requires a target path."
        case .missingReplacement:
            return "BurnBar context selection requires replacement text."
        case .missingReadContent:
            return "BurnBar context selection requires previously-read file content."
        case .replacementNotFound(let needle):
            return "BurnBar could not find '\(needle)' in the previously-read file."
        }
    }
}
