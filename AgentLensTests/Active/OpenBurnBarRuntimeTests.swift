...
final class OpenBurnBarRuntimeTests: XCTestCase {
    ...
    func test_statusItemBrandMark_isIconOnlyByDefault() {
        XCTAssertEqual(OpenBurnBarStatusItemBrandMark.statusItemWidth, NSStatusItem.squareLength)
        XCTAssertEqual(OpenBurnBarStatusItemBrandMark.menuBarTitle, "")
    }
