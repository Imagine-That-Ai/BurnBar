...
final class DomainCoreShadowEvidenceSpoolTests: XCTestCase {
    ...
    func testGenericCollectorRejectsInvalidCoverageOutcomeAndTiming() throws {
        ...
        XCTAssertNil(DomainCoreShadowSampleV3(comparison: valid, channel: "production", candidate: candidate, loadedIdentity: loadedIdentity))
        XCTAssertNil(DomainCoreShadowSampleV3(
            ...
            channel: "internal", candidate: candidate, loadedIdentity: loadedIdentity
        ))
        XCTAssertNil(DomainCoreShadowSampleV3(
            comparison: .init(
