...
///      to `v53` inside a real SQLCipher-keyed `DatabaseQueue` (the production
...
final class DatabaseByteCompatVectorTests: XCTestCase {
    ...
    private let fixtureBaseName = "openburnbar-db-compat-v53"
    ...
    /// The kit is pinned to the `v53` endpoint. A future migration bump must fail
    /// this loudly and force a conscious fixture/vector refresh.
    func test_liveMigrator_endpointIsV53() throws {
        XCTAssertEqual(
        ...
        XCTAssertGreaterThanOrEqual(
            OpenBurnBarDatabase.migrator.migrations.count, 54,
            "Expected at least 54 registered migrations (v1..v53 + v51a interstitial)."
        )
    }
    ...
    /// Migrate a fresh keyed DB to v53, seed the corpus, and measure the schema
