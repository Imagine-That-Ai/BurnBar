...
| Public beta banner                           | `website/src/components/PublicBetaBanner.astro` + `SITE.publicBeta` in `website/src/data/site.ts`; checklist in `docs/WEEKEND_PUBLIC_BETA_LAUNCH.md`                                                                                                                                                                            |
| Linux early beta (ARM64)                     | `SITE.linuxStatus` / `surfaces.ts` linux row — signed prerelease, not a certified macOS peer                                                                                                                                                                                                                                   |
