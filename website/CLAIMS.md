...
| Cloud Ultra = everything in Cloud Pro plus 10× private agent memory (Pensieve limits) — Pro: 3 sources / 5,000 chunks / 25 MB; Ultra: 15 sources / 50,000 chunks / 250 MB                  | `functions/src/callables/knowledgeMemory.ts:94-97` (`PENSIEVE_LIMITS`), `docs/PENSIEVE.md:178-184`                                                                |
