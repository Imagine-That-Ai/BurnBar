...
| Promise: paired-device privacy boundary is designed around sealed credentials and relay encryption; public no-read claims remain gated on runtime evidence | sealed-credential + E2E relay design; `third_party/libsignal/runtime-readiness.json`                                                                                                                           |
...
| Agent memory = repo docs, notes, and chat-derived memories your agents recall; text/vector privacy is designed around sealed/cloaked handling, with public no-read claims gated on CloudVault private-domain runtime evidence | `docs/PENSIEVE.md:178-188`, `OpenBurnBarCore/.../CloudVaultCrypto.swift`, `tools/openburnbar-mcp-remote/src/embed.ts` (vault-key cloaking), `third_party/libsignal/runtime-readiness.json` |
