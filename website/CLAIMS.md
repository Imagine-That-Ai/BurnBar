...
| Claim                                        | Source                                                                                                                                                                                                                                                                                                                           |
| -------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Current public macOS DMG                     | `website/src/data/site.ts`; `https://github.com/Imagine-That-Ai/BurnBar/releases/download/v1.0.25/OpenBurnBar-1.0.25-macOS.dmg`                                                                                                                                                                                                  |
...
4. **Marketing version.** `SITE.macReleaseLatest` / `SITE.macReleaseFile` currently target the
   published `v1.0.25` GitHub DMG as the public macOS download. Restore the branded
