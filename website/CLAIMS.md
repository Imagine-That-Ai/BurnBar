...
| Direct-download releases signed + notarized + stapled                                        | `docs/RELEASE_MACOS.md:42-55`; the `/download` button serves the first-party `downloads.burnbar.ai` host (Cloudflare R2 custom domain, verified live 2026-08-28)                        |
| Direct-download per-release SBOM + checksums + provenance JSON                                | `docs/RELEASE_MACOS.md:43-83`; branded-host assets verified SHA-256-identical to the immutable GitHub v1.0.40+repair.34 release assets (2026-08-28)                                               |
...
| Claim                                        | Source                                                                                                                                                                                                                                                                                                                           |
| -------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Current public macOS DMG                     | `website/src/data/site.ts`; `https://downloads.burnbar.ai/OpenBurnBar-1.0.40+repair.34-macOS.dmg` — SHA-256 verified against the immutable GitHub v1.0.40+repair.34 release asset (2026-08-28)                                                                                                                                                        |
...
`https://downloads.burnbar.ai/OpenBurnBar-1.0.40+repair.34-macOS.dmg`; changing the public DMG URL must
...
4. **Marketing version.** Resolved 2026-08-28 — the branded `downloads.burnbar.ai` host is
   live (Active Cloudflare R2 custom domain) and `SITE.macDownloadBaseUrl` /
   `SITE.macUpdateBaseUrl` now point at it; every v1.0.40+repair.34 artifact was streamed through the
