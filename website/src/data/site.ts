...
export const SITE = {
  ...
  macReleaseLatest: "1.0.28",
  macReleaseFile: "OpenBurnBar-1.0.28-macOS.dmg",
  macAppcastFile: "appcast.xml",
  macUpdateFeedFile: "latest-macos.json",
  macDownloadBaseUrl: "https://github.com/Imagine-That-Ai/BurnBar/releases/download/v1.0.28",
  macUpdateBaseUrl: "",
