...
export const LAUNCH_POSTS: LaunchPost[] = [
  {
    ...
    body:
      "OpenBurnBar watches spend, quota, and agent activity across the AI tools developers already use. The core product stays local and free; BurnBar Cloud adds sync and encrypted history; Cloud Pro adds Floo and supervised Agent Control with prepaid hosted usage.",
  ...
  },
  {
    ...
    body:
      "We built OpenBurnBar because the AI coding bill usually arrives after the work is done. It reads local agent logs, keeps the free tier local-first, and adds optional paid cloud sync and supervised remote-control workflows.",
  ...
  },
  {
    ...
    body:
      "OpenBurnBar helps developers see what their coding agents are doing, what they cost, and when quota is running out. The paid cloud tiers are optional and focused on sync, backup, and supervised control workflows.",
  ...
  },
  {
    ...
    body:
      "OpenBurnBar started as a local meter for my own AI tool usage. It now has a free local product, BurnBar Cloud for sync and encrypted history, and Cloud Pro for phone-to-Mac workflows with explicit hosted-usage caps.",
  ...
  },
  {
    ...
    body:
      "Track cost, quota, sessions, and agent activity across your local developer tools. Start free and local, then add cloud sync or supervised phone-to-Mac control only when you need it.",
    cta: "Get OpenBurnBar"
  },
  {
    channel: "email",
    ...
    body:
      "The free local app remains the foundation. BurnBar Cloud adds sync, backup, search, and agent memory across devices. BurnBar Cloud Pro adds Floo and Agent Control with included monthly allowance and prepaid top-ups.",
