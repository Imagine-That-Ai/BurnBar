...
async function initPretextShrinkwrap() {
  ...
  const elements = document.querySelectorAll(
    ".pretext-wrap, .glass-wrap-text, .trust__head h2, .trust__head .lead, .trust__quote blockquote p, .endcta__h, .endcta__inner h2, .endcta__inner p, .endcta__inner .lead, .pagehead__inner h1:not([data-pretext-native]), .pagehead__inner p, .pagehead__inner .lead, .pagehead__lead"
  );
