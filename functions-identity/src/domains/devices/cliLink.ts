...
import { logError, wrapCallableHandler, wrapRequestHandler } from "@openburnbar/functions-shared/logging.js";
import { enforceHighRiskComputerUseCallableWithNonce } from "@openburnbar/functions-shared/appCheckAttestation.js";
import { REMOTE_MCP_TOKEN_ED25519_PRIVATE_KEY_BASE64 } from "../../callables/remoteMcpSigningSecrets.js";
import { assertActiveBurnBarProEntitlement } from "@openburnbar/functions-shared/shared/entitlements.js";
import { remoteMcpTokenHmacSecretValueForRuntime, remoteMcpTokenSigningSecrets } from "../../callables/remoteMcpSigningSecrets.js";
import { REMOTE_MCP_TOKEN_HASH_PEPPER } from "@openburnbar/functions-shared/remoteMcpGrant.js";
...
import { isSha256Hex, safeEqualHex } from "@openburnbar/functions-shared/hermesGateway.js";
import {
...
import { setPublicJsonNoStoreHeaders } from "@openburnbar/functions-shared/publicHttpSecurityHeaders.js";
