...
import { PI_AGENT_SCHEMA_VERSION, PI_AGENT_PAIRING_TTL_MS, PI_AGENT_MAX_FAILED_PAIRING_ATTEMPTS, writePiAgentAuditEvent } from "@openburnbar/functions-shared/shared/accounts.js";
import { assertActiveHostedQuotaEntitlement } from "@openburnbar/functions-shared/shared/entitlements.js";
import { checkPiAgentRateLimit } from "@openburnbar/functions-shared/shared/providerConnect.js";
import { nowISO, safeIdentifier, requiredIdentifier, boundedTrimmedString } from "@openburnbar/functions-shared/shared/validators.js";
...
import { recordOrUndefined, stripUndefinedObject } from "@openburnbar/functions-shared/guards.js";
import type { PiAgentConnectionDoc, PiAgentConnectionMode, PiAgentPairingDoc } from "@openburnbar/functions-shared/types.js";
    ...
    async (
      ...
      try {
        connection = await db.runTransaction(async (tx) => {
          ...
          const displayName =
            boundedTrimmedString(request.data.displayName, "displayName", 80) ?? pairing.displayName ?? "Pi Agent Host";
