...
extension OpenBurnBarDatabase {
    public static let legacyChatThreadID = "openburnbar-chat-legacy"
    ...
    public enum PoolTuning {
        public static let maximumReaderCount = 8
        public static let busyTimeoutSeconds: TimeInterval = 5
    }

    public static func applyPoolTuning(_ config: inout Configuration) {
