...
public struct BurnBarTextExpansionConsent: Codable, Hashable, Sendable {
    ...
    public let systemIMEEnabled: Bool?

    public init(inAppOnly: Bool, acknowledgedAt: String, declinedGlobalCapture: Bool, systemIMEEnabled: Bool = false) {
        self.inAppOnly = inAppOnly
        self.acknowledgedAt = acknowledgedAt
        self.declinedGlobalCapture = declinedGlobalCapture
        self.systemIMEEnabled = systemIMEEnabled
    }
}
...
public struct BurnBarTextExpansionConsentUpdateRequest: Codable, Hashable, Sendable {
    ...
    public init(inAppOnly: Bool, declinedGlobalCapture: Bool, systemIMEEnabled: Bool = false) {
        self.inAppOnly = inAppOnly
        self.declinedGlobalCapture = declinedGlobalCapture
        self.systemIMEEnabled = systemIMEEnabled
    }
