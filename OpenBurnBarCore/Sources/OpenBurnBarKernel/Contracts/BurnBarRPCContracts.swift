...
public enum BurnBarRPCMethod: String, Codable, CaseIterable, Hashable, Sendable {
    ...
    case safariHandoff = "daemon.safari.handoff"
    ...
    case learningPropose = "daemon.learning.propose"
    case learningRecall = "daemon.learning.recall"
    case learningList = "daemon.learning.list"
    case learningOptIn = "daemon.learning.opt_in"
    case learningUpdate = "daemon.learning.update"
    case learningApprove = "daemon.learning.approve"
    case learningReject = "daemon.learning.reject"
    case learningForget = "daemon.learning.forget"
