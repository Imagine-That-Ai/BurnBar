...
// implementation to OpenBurnBarHermesModels/HermesDomainCoreAdapter.swift. The
// domain-core legacy-deletion ledger pins this path and the HermesDomainCoreMode
