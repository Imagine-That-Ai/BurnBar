...
final class PensieveCloakTSParityTests: XCTestCase {
    ...
    func test_matchesTSReferenceHeads() {
        ...
        let e5h = try PensieveVectorCloak.cloak(basis(5), vaultKey: key, modelVersion: "hashing-bow-v1")
        ...
        let r = try PensieveVectorCloak.cloak(ramp(), vaultKey: key, modelVersion: "bge-small-en-v1.5")
