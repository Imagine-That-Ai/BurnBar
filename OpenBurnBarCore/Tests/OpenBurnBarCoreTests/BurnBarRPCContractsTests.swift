...
final class BurnBarRPCContractsTests: XCTestCase {
    ...
    private static let expectedWireNames: [BurnBarRPCMethod: String] = [
        ...
        .safariBootstrap: "daemon.safari.bootstrap",
        .safariUISnapshot: "daemon.safari.ui.snapshot",
        .safariHandoff: "daemon.safari.handoff",
        .safariApprovalRespond: "daemon.safari.approval.respond",
        .safariTrustUpdate: "daemon.safari.trust.update",
        .safariSessionAttach: "daemon.safari.session.attach",
        .safariSessionDetach: "daemon.safari.session.detach",
        .safariSessionStatus: "daemon.safari.session.status",
        .safariCommandPoll: "daemon.safari.command.poll",
        .safariCommandComplete: "daemon.safari.command.complete",
        .safariPageContext: "daemon.safari.page_context",
        .safariScreenshot: "daemon.safari.screenshot",
        .safariFullPageScreenshot: "daemon.safari.full_page_screenshot",
        .safariClick: "daemon.safari.click",
        .safariType: "daemon.safari.type",
        .safariPressKey: "daemon.safari.press_key",
        .safariScroll: "daemon.safari.scroll",
        .safariHover: "daemon.safari.hover",
        .safariFocus: "daemon.safari.focus",
        .safariSelectOption: "daemon.safari.select_option",
        .safariNavigate: "daemon.safari.navigate",
        .safariOpenTab: "daemon.safari.open_tab",
        .safariCloseTab: "daemon.safari.close_tab",
        .safariListTabs: "daemon.safari.list_tabs",
        .safariWaitFor: "daemon.safari.wait_for",
        .safariRunJavaScript: "daemon.safari.run_javascript",
        .safariExtract: "daemon.safari.extract",
        .safariAbort: "daemon.safari.abort",
        ...
        .runRetry: "run.retry",
        .learningPropose: "daemon.learning.propose",
        .learningRecall: "daemon.learning.recall",
        .learningList: "daemon.learning.list",
        .learningOptIn: "daemon.learning.opt_in",
        .learningUpdate: "daemon.learning.update",
        .learningApprove: "daemon.learning.approve",
        .learningReject: "daemon.learning.reject",
        .learningForget: "daemon.learning.forget",
        .learningRollback: "daemon.learning.rollback",
        .learningTimeline: "daemon.learning.timeline",
        .learningOptOut: "daemon.learning.opt_out",
