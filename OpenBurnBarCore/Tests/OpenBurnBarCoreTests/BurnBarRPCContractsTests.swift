...
final class BurnBarRPCContractsTests: XCTestCase {
    ...
    private static let expectedWireNames: [BurnBarRPCMethod: String] = [
        ...
        .inboxMemoryCandidateApprove: "daemon.inbox.memory_candidate.approve",
        .inboxPlansRememberStep: "daemon.inbox.plans.remember_step",
        .inboxPlansCreateFollowup: "daemon.inbox.plans.create_followup",
