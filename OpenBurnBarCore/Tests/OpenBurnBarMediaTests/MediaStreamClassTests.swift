...
final class MediaStreamClassTests: XCTestCase {
    func testKnownClassesMapToFeatures() {
        ...
        XCTAssertTrue(MediaStreamClass.admitsDesktopVideoFrames(MediaStreamClass.screenVideo.rawValue))
        XCTAssertTrue(MediaStreamClass.admitsDesktopVideoFrames(MediaStreamClass.controlSurfaceFrame.rawValue))
        XCTAssertFalse(MediaStreamClass.admitsDesktopVideoFrames(MediaStreamClass.audioOut.rawValue))
        XCTAssertFalse(MediaStreamClass.admitsDesktopVideoFrames(nil))
