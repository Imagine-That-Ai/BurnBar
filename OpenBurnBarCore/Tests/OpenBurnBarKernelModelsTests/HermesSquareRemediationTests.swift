import XCTest
// B1: PersonaScopeEnvelope / CLIAgentMissionPersonaScopeApplier /
// MiniProgramHostCallValidator / MissionGroupPhaseReducer are public in
// OpenBurnBarKernelContracts — plain import, used through the public API.
