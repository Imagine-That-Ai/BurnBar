import XCTest
// B1: public cross-sub Kernel symbols this test reaches (HermesRelayCrypto,
// HermesRelayEncryptedRequestPayload, CLIAgentSessionRecord/CLIAgentRuntime live in
// OpenBurnBarKernelCrypto; CLIAgentResumeTarget/CLIAgentResumeOutcome/BurnBarRunResumeResponse
// in OpenBurnBarKernelContracts) — plain imports, they are used through the public API.
import OpenBurnBarKernelContracts
