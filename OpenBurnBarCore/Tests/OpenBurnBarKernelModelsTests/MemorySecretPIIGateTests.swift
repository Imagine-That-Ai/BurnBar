...
// packet K2; @testable reaches those internals directly. This test moved to
// OpenBurnBarKernelModelsTests (Phase-2 WS-B packet B1), so it @testable-imports the
// owning module directly instead of the @_exported OpenBurnBarCore/OpenBurnBarKernel umbrellas.
