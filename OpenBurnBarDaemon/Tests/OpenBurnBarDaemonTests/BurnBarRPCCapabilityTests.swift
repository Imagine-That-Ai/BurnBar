...
final class BurnBarRPCCapabilityTests: XCTestCase {
    ...
    func test_highRiskMethodsMapToExpectedGroups() {
        ...
        XCTAssertEqual(BurnBarRPCCapability.capability(for: .providerExternalAuthStart), .config)
        XCTAssertEqual(BurnBarRPCCapability.capability(for: .providerExternalAuthStatus), .config)
        XCTAssertEqual(BurnBarRPCCapability.capability(for: .providerExternalAuthCancel), .config)
    ...
    func test_readOnlyProfileRefusesWritesAndComputerUse() {
        ...
        XCTAssertFalse(profile.permits(.providerExternalAuthStart))
        XCTAssertFalse(profile.permits(.providerExternalAuthStatus))
        XCTAssertFalse(profile.permits(.providerExternalAuthCancel))
