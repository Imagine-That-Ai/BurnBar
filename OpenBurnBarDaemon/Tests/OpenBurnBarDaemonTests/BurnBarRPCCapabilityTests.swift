...
final class BurnBarRPCCapabilityTests: XCTestCase {
    ...
    func test_highRiskMethodsMapToExpectedGroups() {
        ...
        XCTAssertEqual(BurnBarRPCCapability.capability(for: .memorySnapshotUpsert), .memoryWrite)
        XCTAssertEqual(BurnBarRPCCapability.capability(for: .memorySnapshotDelete), .memoryWrite)
        XCTAssertEqual(BurnBarRPCCapability.capability(for: .memorySnapshotDeleteAll), .memoryWrite)
    ...
    func test_readOnlyProfileRefusesWritesAndComputerUse() {
        ...
        XCTAssertFalse(profile.permits(.memorySnapshotUpsert))
        XCTAssertFalse(profile.permits(.memorySnapshotDelete))
