    ...
    @unchecked Sendable
{
    ...
    func start() throws -> SafariHandoffProcessSupervisor.WatchdogReady {
        ...
        return .init(watchdogPID: 10_001, processGroupID: 10_002)
    }
    ...
    func forceContainment() {
        locked { _forceContainmentCount += 1 }
    }

    func closeLiveness() {
        locked { _closeLivenessCount += 1 }
    }
...
private final class SafariHandoffTestWorkspace {
    ...
    func writeReceipt(
        ...
        let receipt = SafariHandoffTestReceipt(
