...
public actor BurnBarMissionControlStore {
    ...
    var projection: BurnBarMissionControlProjectionFile?
    ...
    func ensureLoaded(loadEventsForRecentActivity: Bool = false) throws {
        if projection != nil {
    ...
    func applyTeamCollaborationMetadata(
        _ metadata: BurnBarMetadata,
    ...
    func missionValue(_ id: BurnBarMissionID) throws -> BurnBarMissionSnapshot {
