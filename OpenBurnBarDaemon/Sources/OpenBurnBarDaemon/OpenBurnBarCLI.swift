...
public struct BurnBarCLIRunner {
    ...
    private func formatQuestions(_ questions: [BurnBarPendingQuestionSnapshot]) -> String {
        ...
        return questions.map { question in
            let stage: String
            if let rawStage = question.stageLabel,
               rawStage.trimmingCharacters(in: .whitespacesAndNewlines).isEmpty == false {
                stage = " [\(rawStage)]"
            } else {
                stage = ""
            }
    ...
    func formatRunList(_ response: BurnBarRunListResponse) -> String {
    ...
    func formatRunDetail(_ response: BurnBarRunDetailResponse) -> String {
    ...
    func formatRunPoll(_ response: BurnBarRunEventBatch) -> String {
    ...
    func formatRunPollJSON(_ response: BurnBarRunEventBatch) throws -> String {
    ...
    func positionalArguments(_ arguments: [String], optionNames: Set<String>) -> [String] {
        var output: [String] = []
        var index = 0
    ...
    static func resumeOptionValue(_ name: String, in arguments: [String]) throws -> String? {
    ...
    func requiredOption(_ name: String, in arguments: [String]) throws -> String {
    ...
    func positiveIntegerOption(_ name: String, in arguments: [String], defaultValue: Int) throws -> Int {
