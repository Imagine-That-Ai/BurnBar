...
// The burnbarOperator claim had no mint path and was retired: even a caller
// presenting the legacy claim is denied operator metrics.
await assertFails(getDoc(doc(operatorDB, "ops/media_budget_status/metrics/current")));
