...
const explicitTypes = {
  ...
  "daemon.account.status": ["BurnBarRPCRequestEnvelope", "BurnBarAccountStatusResponse"],
  "daemon.account.device_auth.start": ["BurnBarRPCRequestEnvelope", "BurnBarAccountStatusResponse"],
  ...
  "daemon.provider.external_auth.start": ["BurnBarProviderExternalAuthStartRequest", "BurnBarProviderExternalAuthResponse"],
  "daemon.provider.external_auth.status": ["BurnBarProviderExternalAuthStatusRequest", "BurnBarProviderExternalAuthResponse"],
  "daemon.provider.external_auth.cancel": ["BurnBarProviderExternalAuthFlowRequest", "BurnBarProviderExternalAuthResponse"],
