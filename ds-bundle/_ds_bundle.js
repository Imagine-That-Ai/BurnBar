/* @ds-bundle: {"namespace":"OpenBurnBarConsole","components":[{"name":"Badge","sourcePath":"components/primitives/Badge/Badge.jsx"},{"name":"BrandMark","sourcePath":"components/brand/BrandMark/BrandMark.jsx"},{"name":"Button","sourcePath":"components/primitives/Button/Button.jsx"},{"name":"Card","sourcePath":"components/primitives/Card/Card.jsx"},{"name":"Dialog","sourcePath":"components/primitives/Dialog/Dialog.jsx"},{"name":"DotCrestField","sourcePath":"components/brand/DotCrestField/DotCrestField.jsx"},{"name":"Progress","sourcePath":"components/primitives/Progress/Progress.jsx"},{"name":"TierBadge","sourcePath":"components/brand/TierBadge/TierBadge.jsx"},{"name":"TierGlyph","sourcePath":"components/brand/TierGlyph/TierGlyph.jsx"}],"sourceHashes":{"components/primitives/Badge/Badge.jsx":"9eae3238f6d8","components/primitives/Badge/Badge.d.ts":"b4e5e3c9a1d1","components/primitives/Badge/Badge.prompt.md":"a448b7205d70","components/brand/BrandMark/BrandMark.jsx":"88910a10e605","components/brand/BrandMark/BrandMark.d.ts":"232c8c725ffb","components/brand/BrandMark/BrandMark.prompt.md":"4ba9e5fbdb7f","components/primitives/Button/Button.jsx":"c99b562689f1","components/primitives/Button/Button.d.ts":"4e2f06400161","components/primitives/Button/Button.prompt.md":"c2cc5f39a927","components/primitives/Card/Card.jsx":"7e1a8433ff89","components/primitives/Card/Card.d.ts":"d7ced40c0c24","components/primitives/Card/Card.prompt.md":"2fbe4d8b071f","components/primitives/Dialog/Dialog.jsx":"8381f92f71e3","components/primitives/Dialog/Dialog.d.ts":"a175fc80a1b2","components/primitives/Dialog/Dialog.prompt.md":"cafa0d5661d9","components/brand/DotCrestField/DotCrestField.jsx":"f1d50c36a9f4","components/brand/DotCrestField/DotCrestField.d.ts":"12876a2c0a72","components/brand/DotCrestField/DotCrestField.prompt.md":"211709ba22b1","components/primitives/Progress/Progress.jsx":"5a5eb26d6832","components/primitives/Progress/Progress.d.ts":"b144268b9675","components/primitives/Progress/Progress.prompt.md":"853fd58085f6","components/brand/TierBadge/TierBadge.jsx":"4b3e0e579b1f","components/brand/TierBadge/TierBadge.d.ts":"ccd06d8ff52a","components/brand/TierBadge/TierBadge.prompt.md":"4a42e0d7ed1c","components/brand/TierGlyph/TierGlyph.jsx":"da46879b76bf","components/brand/TierGlyph/TierGlyph.d.ts":"204b111d947b","components/brand/TierGlyph/TierGlyph.prompt.md":"7e4ca5175b31"},"inlinedExternals":["@radix-ui/primitive","@radix-ui/react-compose-refs","@radix-ui/react-context","@radix-ui/react-dialog","@radix-ui/react-dismissable-layer","@radix-ui/react-focus-guards","@radix-ui/react-focus-scope","@radix-ui/react-id","@radix-ui/react-portal","@radix-ui/react-presence","@radix-ui/react-primitive","@radix-ui/react-slot","@radix-ui/react-use-callback-ref","@radix-ui/react-use-controllable-state","@radix-ui/react-use-effect-event","@radix-ui/react-use-escape-keydown","@radix-ui/react-use-layout-effect","aria-hidden","class-variance-authority","clsx","detect-node-es","get-nonce","lucide-react","react-remove-scroll","react-remove-scroll-bar","react-style-singleton","tailwind-merge","tslib","use-callback-ref","use-sidecar"],"builtBy":"cc-design-sync"} */
"use strict";
var OpenBurnBarConsole = (() => {
  ...
  // apps/console/node_modules/@radix-ui/react-slot/dist/index.mjs
  init_define_import_meta_env();
  var React3 = __toESM(require_react_shim(), 1);

  // apps/console/node_modules/@radix-ui/react-compose-refs/dist/index.mjs
  init_define_import_meta_env();
  ...
  // apps/console/node_modules/class-variance-authority/dist/index.mjs
  init_define_import_meta_env();

  // apps/console/node_modules/clsx/dist/clsx.mjs
  init_define_import_meta_env();
  function r(e) {
    var t, f, n = "";
  ...
  // apps/console/node_modules/tailwind-merge/dist/bundle-mjs.mjs
  init_define_import_meta_env();
    ...
    "btn-quiet inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 [&_svg]:size-4 [&_svg]:shrink-0",
    {
      variants: {
        variant: {
          ...
          destructive: "bg-transparent text-[color:var(--color-seal-crimson)] border border-[color:var(--color-seal-crimson)] hover:bg-[color:var(--color-seal-crimson)] hover:text-white",
  ...
  var Button = React4.forwardRef(
    ({ className, variant, size, asChild = false, ...props }, ref) => {
      ...
      return /* @__PURE__ */ React4.createElement(Comp, { className: cn(buttonVariants({ variant, size, className })), ref, ...props });
    }
  );
  ...
  var badgeVariants = cva(
    "inline-flex items-center gap-1.5 rounded-pill border px-2.5 py-0.5 text-xs font-medium font-mono tracking-tight",
    {
      variants: {
        tier: {
          server_readable: "border-[color:var(--color-tier-server-readable)]/40 text-[color:var(--color-tier-server-readable)] bg-[color:var(--color-tier-server-readable)]/10",
          zero_access: "border-[color:var(--color-tier-zero-access)]/40 text-[color:var(--color-tier-zero-access)] bg-[color:var(--color-tier-zero-access)]/10",
          end_to_end: "border-[color:var(--color-tier-end-to-end)]/40 text-[color:var(--color-tier-end-to-end)] bg-[color:var(--color-tier-end-to-end)]/10",
  ...
  function Badge({ className, tier, ...props }) {
    return /* @__PURE__ */ React5.createElement("span", { className: cn(badgeVariants({ tier }), className), ...props });
  }
  ...
  var Card = React6.forwardRef(
    ({ className, ...props }, ref) => /* @__PURE__ */ React6.createElement("div", { ref, className: cn("glass-pane p-token-6", className), ...props })
  );
  Card.displayName = "Card";
  var CardHeader = React6.forwardRef(
    ({ className, ...props }, ref) => /* @__PURE__ */ React6.createElement("div", { ref, className: cn("flex flex-col gap-1.5", className), ...props })
  );
  CardHeader.displayName = "CardHeader";
  var CardTitle = React6.forwardRef(
    ({ className, ...props }, ref) => /* @__PURE__ */ React6.createElement("h3", { ref, className: cn("font-display text-lg text-content-bright", className), ...props })
  );
  CardTitle.displayName = "CardTitle";
  var CardDescription = React6.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ React6.createElement("p", { ref, className: cn("text-sm text-content-mute", className), ...props }));
  CardDescription.displayName = "CardDescription";
  var CardContent = React6.forwardRef(
    ({ className, ...props }, ref) => /* @__PURE__ */ React6.createElement("div", { ref, className: cn("pt-token-4", className), ...props })
  );
  ...
  // apps/console/node_modules/@radix-ui/react-dialog/dist/index.mjs
  init_define_import_meta_env();
  var React30 = __toESM(require_react_shim(), 1);

  // apps/console/node_modules/@radix-ui/primitive/dist/index.mjs
  init_define_import_meta_env();
  ...
  // apps/console/node_modules/@radix-ui/react-context/dist/index.mjs
  init_define_import_meta_env();
  ...
  // apps/console/node_modules/@radix-ui/react-id/dist/index.mjs
  init_define_import_meta_env();
  var React9 = __toESM(require_react_shim(), 1);

  // apps/console/node_modules/@radix-ui/react-use-layout-effect/dist/index.mjs
  init_define_import_meta_env();
  ...
  // apps/console/node_modules/@radix-ui/react-use-controllable-state/dist/index.mjs
  init_define_import_meta_env();
  ...
  // apps/console/node_modules/@radix-ui/react-dismissable-layer/dist/index.mjs
  init_define_import_meta_env();
  var React15 = __toESM(require_react_shim(), 1);

  // apps/console/node_modules/@radix-ui/react-primitive/dist/index.mjs
  init_define_import_meta_env();
  var React12 = __toESM(require_react_shim(), 1);
  var ReactDOM = __toESM(require_react_dom_shim(), 1);

  // apps/console/node_modules/@radix-ui/react-primitive/node_modules/@radix-ui/react-slot/dist/index.mjs
  init_define_import_meta_env();
  ...
  function createSlot2(ownerName) {
    ...
    const Slot22 = React11.forwardRef((props, forwardedRef) => {
      ...
      if (slottable) {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React11.isValidElement(newElement) ? React11.cloneElement(newElement, void 0, newChildren) : null });
      }
  ...
  // apps/console/node_modules/@radix-ui/react-use-callback-ref/dist/index.mjs
  init_define_import_meta_env();
  ...
  // apps/console/node_modules/@radix-ui/react-use-escape-keydown/dist/index.mjs
  init_define_import_meta_env();
  ...
  // apps/console/node_modules/@radix-ui/react-focus-scope/dist/index.mjs
  init_define_import_meta_env();
  ...
  // apps/console/node_modules/@radix-ui/react-portal/dist/index.mjs
  init_define_import_meta_env();
  ...
  // apps/console/node_modules/@radix-ui/react-presence/dist/index.mjs
  init_define_import_meta_env();
  ...
  // apps/console/node_modules/@radix-ui/react-focus-guards/dist/index.mjs
  init_define_import_meta_env();
  ...
  // apps/console/node_modules/react-remove-scroll/dist/es2015/index.js
  init_define_import_meta_env();

  // apps/console/node_modules/react-remove-scroll/dist/es2015/Combination.js
  init_define_import_meta_env();

  // apps/console/node_modules/tslib/tslib.es6.mjs
  init_define_import_meta_env();
  ...
  // apps/console/node_modules/react-remove-scroll/dist/es2015/UI.js
  init_define_import_meta_env();
  var React24 = __toESM(require_react_shim());

  // apps/console/node_modules/react-remove-scroll-bar/dist/es2015/constants.js
  init_define_import_meta_env();
  ...
  // apps/console/node_modules/use-callback-ref/dist/es2015/index.js
  init_define_import_meta_env();

  // apps/console/node_modules/use-callback-ref/dist/es2015/assignRef.js
  init_define_import_meta_env();
  ...
  // apps/console/node_modules/use-callback-ref/dist/es2015/useRef.js
  init_define_import_meta_env();
  ...
  // apps/console/node_modules/use-callback-ref/dist/es2015/useMergeRef.js
  init_define_import_meta_env();
  ...
  // apps/console/node_modules/react-remove-scroll/dist/es2015/medium.js
  init_define_import_meta_env();

  // apps/console/node_modules/use-sidecar/dist/es2015/index.js
  init_define_import_meta_env();

  // apps/console/node_modules/use-sidecar/dist/es2015/medium.js
  init_define_import_meta_env();
  function ItoI(a) {
    return a;
  }
  ...
  // apps/console/node_modules/use-sidecar/dist/es2015/exports.js
  init_define_import_meta_env();
  ...
  // apps/console/node_modules/react-remove-scroll/dist/es2015/sidecar.js
  init_define_import_meta_env();

  // apps/console/node_modules/react-remove-scroll/dist/es2015/SideEffect.js
  init_define_import_meta_env();
  var React27 = __toESM(require_react_shim());

  // apps/console/node_modules/react-remove-scroll-bar/dist/es2015/index.js
  init_define_import_meta_env();

  // apps/console/node_modules/react-remove-scroll-bar/dist/es2015/component.js
  init_define_import_meta_env();
  var React26 = __toESM(require_react_shim());

  // apps/console/node_modules/react-style-singleton/dist/es2015/index.js
  init_define_import_meta_env();

  // apps/console/node_modules/react-style-singleton/dist/es2015/component.js
  init_define_import_meta_env();

  // apps/console/node_modules/react-style-singleton/dist/es2015/hook.js
  init_define_import_meta_env();
  var React25 = __toESM(require_react_shim());

  // apps/console/node_modules/react-style-singleton/dist/es2015/singleton.js
  init_define_import_meta_env();

  // apps/console/node_modules/get-nonce/dist/es2015/index.js
  init_define_import_meta_env();
  var currentNonce;
  ...
  // apps/console/node_modules/react-remove-scroll-bar/dist/es2015/utils.js
  init_define_import_meta_env();
  var zeroGap = {
    left: 0,
    top: 0,
  ...
  // apps/console/node_modules/react-remove-scroll/dist/es2015/aggresiveCapture.js
  init_define_import_meta_env();
  ...
  // apps/console/node_modules/react-remove-scroll/dist/es2015/handleScroll.js
  init_define_import_meta_env();
  ...
  // apps/console/node_modules/aria-hidden/dist/es2015/index.js
  init_define_import_meta_env();
  ...
  // apps/console/node_modules/@radix-ui/react-dialog/node_modules/@radix-ui/react-slot/dist/index.mjs
  init_define_import_meta_env();
  ...
  function createSlot3(ownerName) {
    ...
    const Slot22 = React29.forwardRef((props, forwardedRef) => {
      ...
      if (slottable) {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React29.isValidElement(newElement) ? React29.cloneElement(newElement, void 0, newChildren) : null });
      }
  ...
  var DialogPortal = (props) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(PortalProvider, { scope: __scopeDialog, forceMount, children: React30.Children.map(children, (child) => /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(Presence, { present: forceMount || context.open, children: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(Portal, { asChild: true, container, children: child }) })) });
  };
...
For more information, see https://radix-ui.com/primitives/docs/components/${titleWarningContext.docsSlug}`;
  ...
  // apps/console/node_modules/lucide-react/dist/esm/icons/eye.js
  init_define_import_meta_env();
  ...
  // apps/console/node_modules/lucide-react/dist/esm/icons/lock.js
  init_define_import_meta_env();
  ...
  // apps/console/node_modules/lucide-react/dist/esm/icons/x.js
  init_define_import_meta_env();
  ...
  var DialogOverlay2 = React31.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ React31.createElement(
    Overlay,
    {
      ref,
      className: cn(
  ...
  var DialogContent2 = React31.forwardRef(({ className, children, ...props }, ref) => /* @__PURE__ */ React31.createElement(DialogPortal2, null, /* @__PURE__ */ React31.createElement(DialogOverlay2, null), /* @__PURE__ */ React31.createElement(
    Content,
    {
      ref,
      className: cn(
        "glass-pane glass-pane--elevated fixed left-1/2 top-1/2 z-50 grid w-full max-w-lg -translate-x-1/2 -translate-y-1/2 gap-token-4 p-token-6 shadow-2xl data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95",
        className
      ),
      ...props
    },
    children,
    /* @__PURE__ */ React31.createElement(Close, { className: "absolute right-4 top-4 rounded-sm text-content-mute opacity-70 transition-opacity hover:opacity-100 focus:outline-none" }, /* @__PURE__ */ React31.createElement(X, { className: "size-4" }), /* @__PURE__ */ React31.createElement("span", { className: "sr-only" }, "Close"))
  )));
  DialogContent2.displayName = Content.displayName;
  var DialogHeader = ({ className, ...props }) => /* @__PURE__ */ React31.createElement("div", { className: cn("flex flex-col gap-1.5", className), ...props });
  DialogHeader.displayName = "DialogHeader";
  var DialogFooter = ({ className, ...props }) => /* @__PURE__ */ React31.createElement("div", { className: cn("flex flex-col-reverse gap-2 sm:flex-row sm:justify-end", className), ...props });
  DialogFooter.displayName = "DialogFooter";
  var DialogTitle2 = React31.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ React31.createElement(
    Title,
    {
      ref,
      className: cn("font-display text-lg text-content-bright", className),
      ...props
    }
  ));
  DialogTitle2.displayName = Title.displayName;
  var DialogDescription2 = React31.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ React31.createElement(
    Description,
    {
      ref,
      className: cn("text-sm text-content-mute", className),
      ...props
    }
  ));
  DialogDescription2.displayName = Description.displayName;

  // apps/console/components/ui/progress.tsx
  init_define_import_meta_env();
  var React32 = __toESM(require_react_shim(), 1);
  function Progress({ value, fillVar = "--color-brass-core", className, ...props }) {
  ...
  // apps/console/components/BrandMark.tsx
  init_define_import_meta_env();
  var import_react4 = __toESM(require_react_shim(), 1);
  function BrandMark({ size = 92 }) {
    const [videoFailed, setVideoFailed] = (0, import_react4.useState)(false);
    return /* @__PURE__ */ React.createElement(
      "span",
      {
        ...
        style: {
          ...
          boxShadow: "0 1px 2px rgba(22,20,15,0.06), 0 14px 30px -16px rgba(22,20,15,0.5), inset 0 1px 0 rgba(255,255,255,0.8)"
        }
      },
      !videoFailed ? /* @__PURE__ */ React.createElement(
        "video",
        {
      ...
      ), /* @__PURE__ */ React.createElement("span", { className: "brand-sheen" }))
    );
  }

  // apps/console/components/basin/TierGlyph.tsx
  init_define_import_meta_env();
  ...
  var mix = (a, b, t) => Math.round(a + (b - a) * t);
  function TierGlyph({
    glyph,
    colorVar,
    size = 34,
      ...
      const draw = (now) => {
        ...
        for (let r2 = 0; r2 < N; r2++) {
          for (let c = 0; c < N; c++) {
            ...
            if (rows[r2][c] === "1") {
              const wave = Math.sin((c + (N - r2)) / N * Math.PI * 2 - t * 15e-4);
  ...
  // apps/console/components/inventory/TierBadge.tsx
  init_define_import_meta_env();

  // apps/console/lib/domains.ts
  init_define_import_meta_env();

  // apps/console/lib/domains.generated.ts
  init_define_import_meta_env();
  var DATA_DOMAINS = [
    {
      "id": "usage_spend",
  ...
  var DATA_DOMAIN_IDS = DATA_DOMAINS.map((d) => d.id);
  ...
  function TierBadge({ tier }) {
    ...
    const Icon2 = ICON[tier];
    return /* @__PURE__ */ React.createElement(Badge, { tier, title: meta.whoReads }, /* @__PURE__ */ React.createElement(Icon2, { className: "size-3", "aria-hidden": true }), meta.badge);
  }

  // apps/console/components/DotCrestField.tsx
  init_define_import_meta_env();
  ...
  var PERIOD = 9.5;
  var MAX_SUMMONED = 3;
  var SUMMON_RESOLVE = 0.7;
  var SUMMON_HOLD = 1.5;
  var SUMMON_DISSOLVE = 1;
  var SUMMON_SCALE = 0.82;
    ...
    (0, import_react6.useEffect)(() => {
          ...
          for (let y = 0; y < S; y += GAP) {
            for (let x = 0; x < S; x += GAP) {
              ...
              if (bgOpaque) {
                ...
                if (dr * dr + dg * dg + db * db < 3e3) continue;
              }
              const nx = x / S - 0.5;
              const ny = y / S - 0.5;
              const ang = pseudo(x * 1.7, y * 0.7) * Math.PI * 2;
              const rad = Math.hypot(nx, ny) || 1e-3;
              dots.push({
                x: nx,
                y: ny,
                r: data[i],
      ...
      LOGOS.forEach((logo, ci) => {
        if (logo.src.endsWith(".svg")) {
          fetch(logo.src).then((r2) => r2.text()).then((svg) => {
            const m = svg.match(/viewBox=["']\s*[\d.]+\s+[\d.]+\s+([\d.]+)\s+([\d.]+)/);
            const vbw = m ? parseFloat(m[1]) : 140;
            const vbh = m ? parseFloat(m[2]) : 140;
            const sized = /<svg[^>]*\swidth=/.test(svg) ? svg : svg.replace("<svg", `<svg width="${vbw}" height="${vbh}"`);
      ...
      let start = 0;
      let lastPaint = 0;
      const instances = [{ kind: "ambient" }];
      const renderDots = (dots, idx, cx2, cy, coh, baseT, T, scale) => {
        const size = Math.min(W, H) * LOGOS[idx].scale * scale;
        const scatter = (1 - coh) * size * 0.6;
      ...
      const draw = (now) => {
        ...
        const baseT = (reduced ? 4 : now - start) / 1e3;
        const T = now * 11e-4;
        for (let i = instances.length - 1; i >= 0; i--) {
          ...
          if (inst.kind === "ambient") {
            ...
            const cx2 = (0.2 + 0.6 * hx) * W + (reduced ? 0 : Math.sin(baseT * 0.5 + cycleNum) * W * 0.02);
            const cy = (0.22 + 0.54 * hy) * H + (reduced ? 0 : Math.cos(baseT * 0.6 + cycleNum) * H * 0.02);
            renderDots(dots, idx, cx2, cy, coh, baseT, T, 1);
          } else {
            ...
            const age = (now - inst.bornAt) / 1e3;
            const total = SUMMON_RESOLVE + SUMMON_HOLD + SUMMON_DISSOLVE;
            if (age >= total) {
              instances.splice(i, 1);
              continue;
            }
            const coh = smoothstep(0, SUMMON_RESOLVE, age) * (1 - smoothstep(total - SUMMON_DISSOLVE, total, age));
            if (coh <= 0.01) continue;
      ...
      const onPointer = (e) => {
        ...
        if (active >= MAX_SUMMONED) return;
        const idx = summonCounter++ % LOGOS.length;
        const dots = sampled[idx];
        if (!dots || !dots.length) return;
        const size = Math.min(W, H) * LOGOS[idx].scale * SUMMON_SCALE;
        const half = size / 2;
        const cx2 = Math.max(half, Math.min(W - half, e.clientX));
        const cy = Math.max(half, Math.min(H - half, e.clientY));
        instances.push({ kind: "summoned", idx, cx: cx2, cy, bornAt: performance.now() });
      };
...
lucide-react/dist/esm/lucide-react.js:
   ...
   *)
*/
window.OpenBurnBarConsole=OpenBurnBarConsole.__dsMainNs?Object.assign({},OpenBurnBarConsole,OpenBurnBarConsole.__dsMainNs,{__dsMainNs:undefined}):OpenBurnBarConsole;
