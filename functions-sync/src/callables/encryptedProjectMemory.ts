...
import { nowISO, requiredIdentifier, requireHexDigest, requireBoundedNumber, optionalISODateString, requireBoundedStringArray, parseProjectMemoryFreshness, requireCloudVaultBlobEnvelope, cloudVaultAADContext, sha256Hex } from "@openburnbar/functions-shared/shared/validators.js";
import type { ProjectMemorySnapshotDoc } from "@openburnbar/functions-shared/types.js";
import { errorMessage, stripUndefinedObject } from "@openburnbar/functions-shared/guards.js";
import { logWarn, wrapCallableHandler } from "@openburnbar/functions-shared/logging.js";
