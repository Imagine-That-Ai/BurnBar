...
} from "./agentNotificationTriggers.js";
...
// `as const` keeps the literal narrow; createNotificationEvent still
// type-checks it against the source-kind union at the call site.
const SOURCE_KIND = "ai_inbox_item" as const;
