import { errorMessage, isRecord, isTimestampWithToMillis, numberField } from "@openburnbar/functions-shared/guards.js";
/**
...
import { assertAppCheck, assertAuth } from "@openburnbar/functions-shared/auth.js";
import { assertCloudFeatureNotSuspended } from "@openburnbar/functions-shared/cloudFeatureSuspensions.js";
import { checkHostedInsightsAnswerRateLimit } from "@openburnbar/functions-shared/callables/publicRateLimit.js";
