...
import { logCallableStart, traceIdFromCallableRequest, wrapCallableHandler } from "@openburnbar/functions-shared/logging.js";
import { resilientFetch } from "@openburnbar/functions-shared/resilienceHelpers.js";
import { readOpenBurnBarFunctionsConfig } from "@openburnbar/functions-shared/firebaseRuntime.js";
import { isRecord, jsonObject, stringField } from "@openburnbar/functions-shared/guards.js";
import { FUNCTIONS_REGION } from "@openburnbar/functions-shared/runtimeOptions.js";
import { execFileAsync, fetchGoogleIdentityToken, otsBinaryPath, otsVerifierServiceAudience } from "@openburnbar/functions-shared/shared/otsStamping.js";
