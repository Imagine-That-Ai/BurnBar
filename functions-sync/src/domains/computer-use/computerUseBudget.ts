...
import type { ComputerUseBudgetStatusDoc } from "@openburnbar/functions-shared/types.js";
...
import { logError, logInfo, logWarn } from "@openburnbar/functions-shared/logging.js";
...
async function loadBudgetTunings(): Promise<BudgetTunings> {
  try {
    ...
    const { captureException } = await import("@openburnbar/functions-shared/sentry.js");
