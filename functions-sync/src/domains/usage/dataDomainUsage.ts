...
import { BURNBAR_PRO_ENTITLEMENT_ID, BURNBAR_ULTRA_ENTITLEMENT_ID, BURNBAR_PRO_MAX_ENTITLEMENT_ID, isActiveHostedQuotaEntitlement, isActivePremiumEntitlement, isActiveBurnBarUltraEntitlement, isActiveBurnBarCloudProEntitlement } from "@openburnbar/functions-shared/shared/entitlements.js";
import { PENSIEVE_LIMITS } from "../knowledge/knowledgeMemory.js";
