...
import { assertActiveBurnBarCloudProEntitlement, assertActiveBurnBarProEntitlement, isActiveBurnBarCloudProEntitlement, isActiveBurnBarUltraEntitlement, BURNBAR_PRO_MAX_ENTITLEMENT_ID, BURNBAR_ULTRA_ENTITLEMENT_ID } from "@openburnbar/functions-shared/shared/entitlements.js";
import { boundedTrimmedString, requiredIdentifier, requireRecordArray } from "@openburnbar/functions-shared/shared/validators.js";
import {
