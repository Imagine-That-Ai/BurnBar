...
/// <summary>Creates a one-frame WGC capturer for an existing HWND without showing a picker.</summary>
[SupportedOSPlatform("windows10.0.19041.0")]
public static class WindowsGraphicsCaptureFactory
{
    ...
    public static WindowsGraphicsCaptureScreenCapturer CreateForWindow(IntPtr hwnd)
    {
        if (hwnd == IntPtr.Zero)
        {
        ...
        return new WindowsGraphicsCaptureScreenCapturer(item, device, ownsResources: true);
    }
    ...
    private static GraphicsCaptureItem CreateItemForWindow(IntPtr hwnd)
    {
        ...
        try
        {
            ...
            Marshal.ThrowExceptionForHR(factory.CreateForWindow(hwnd, ref itemIid, out itemPointer));
