...
public static class SqlCipherConnection
{
    ...
    {
        SqlCipherPinnedParams.ValidatePassphrase(passphrase);
    ...
    public static void AssertPinnedParams(SqliteConnection connection, out string cipherVersion)
    {
        ...
        RequireInt(connection, "cipher_page_size", SqlCipherPinnedParams.CipherPageSize);
        RequireInt(connection, "kdf_iter", SqlCipherPinnedParams.KdfIter);
        RequireString(connection, "cipher_hmac_algorithm", SqlCipherPinnedParams.HmacAlgorithm);
        RequireString(connection, "cipher_kdf_algorithm", SqlCipherPinnedParams.KdfAlgorithm);
    }
