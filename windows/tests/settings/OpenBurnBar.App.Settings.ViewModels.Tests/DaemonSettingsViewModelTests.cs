...
public sealed class DaemonSettingsViewModelTests
{
    ...
    public void Summary_ProjectsTheMatrixTotals()
    {
        ...
        Assert.Equal(27, vm.Summary.SubstitutedAlready);
        ...
        Assert.Equal(27, vm.Summary.LiveOnV1);
    }
    ...
    public void HeaderLine_MentionsEveryDispositionTally()
    {
        ...
        Assert.Contains("27 substituted", vm.Summary.HeaderLine);
    ...
    public void Filter_NarrowsVisibleRowsToOneDisposition()
    {
        ...
        Assert.Equal(27, vm.VisibleCount);
    ...
    public void FilterOptions_CoverAllPlusEachDispositionWithCounts()
    {
        ...
        Assert.Equal(27, vm.FilterOptions.Single(o => o.Disposition == DaemonSubstitutionDisposition.SubstitutedAlready).Count);
