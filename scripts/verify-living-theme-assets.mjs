...
const assetRoot = resolve(repoRoot, "android/app/src/main/assets/living-themes/kernels");
...
console.log(`Verified ${entries.length} Living Themes and all referenced shader assets.`);
