...
ANDROID_DIFF_COVERAGE_ALLOWLIST_JSON="$(cat <<'JSON'
{
  ...
  "android/app/src/main/java/com/openburnbar/data/models/generated/DaemonRpcModels.kt": "Generated schema mirror from the TypeSpec-first daemon-rpc catalog (wave 3.6); source-of-truth drift is guarded by schema sync and consumer contract tests rather than local line coverage.",
