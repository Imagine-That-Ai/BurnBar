...
export const DOMAIN_CORE_REQUIRED_COVERAGE = Object.freeze({
  ...
  cloudvault: Object.freeze({
    foundation: Object.freeze(["apple", "android", "windows", "console", "local-mcp"]),
    aes: Object.freeze(["apple", "android", "windows", "console", "local-mcp"]),
    ...
    search: Object.freeze(["apple", "android", "local-mcp"]),
    "opaque-identifiers": Object.freeze(["local-mcp"]),
  }),
