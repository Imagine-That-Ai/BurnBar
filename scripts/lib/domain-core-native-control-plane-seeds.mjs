...
export const NATIVE_RELEASE_CONTROL_PLANE_SEEDS = Object.freeze([
  ...
  "scripts/ci/create-openburnbar-direct-release-receipt.py",
  ...
  "scripts/ci/run-android-release-startup-smoke.sh",
  ...
  "scripts/ci/stage-sqlcipher-framework.test.py",
  ...
  "scripts/ci/verify-iroh-release-artifact.sh",
  "scripts/ci/verify-libsignal-pin.sh",
  "scripts/ci/verify-libsignal-submodule-delta.sh",
  "scripts/ci/verify-openburnbar-direct-release.sh",
  ...
  "scripts/lib/apple-static-archive.sh",
  ...
  "scripts/lib/exact-candidate-git.sh",
