...
def main() -> None:
    ...
    if args.mode == "snapshot":
        ...
        result = {"producer": "openburnbar-p17-atspi-control-v1", "activation": activate(find(app, args.name, args.role, True))}
        ...
        result = {"producer": "openburnbar-p17-atspi-control-v1", "edited": {"name": safe(getattr(node, "name", "")), "role": role(node)}}
    else:
