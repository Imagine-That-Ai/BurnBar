...
daemon_linux_tests=(
    ...
    BurnBarRunServiceComputerUseHandshakeTests/testSystemToolCreatesExactManagedComputerUseRequirement
    ...
    ComputerUseServiceRunBindingTests/testAgentWatchSessionCannotReserveAgentRunBinding
    ...
    ComputerUseServiceRunBindingTests/testSystemSessionRequiresRunBinding
    ...
    LinuxComputerUseServiceSystemInputTests/testSystemRuntimeRevocationDuringStartFailsWithoutLeavingSessionAuthority
    ...
    
