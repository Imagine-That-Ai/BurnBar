...
daemon_linux_tests=(
    ...
    OpenBurnBarHTTPGatewayServerLinuxTests/testForgedSafariHeadersAreRejectedBeforeModelCatalogDiscovery
    OpenBurnBarHTTPGatewayServerLinuxTests/testForgedSafariHeadersAreRejectedBeforeProviderContact
