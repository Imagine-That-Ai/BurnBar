...
linux_inner() {
...

  {
    ...
    echo "artifacts=provider-log-path-matrix.json provider-discovery-edge-fixture.json llmsafe-content-linux-fixture.json cli-hermes-transcript.txt contract-status.json"
