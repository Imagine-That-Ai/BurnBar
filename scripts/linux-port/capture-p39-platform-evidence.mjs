...
export function validateP39ProducerArtifact(document) {
  ...
  if (document.payload.corpus.source !== DEFAULT_GOLDEN_PATH
      || !SHA256.test(document.payload.corpus.baselineSha256 ?? '')) {
...
export function captureP39PlatformEvidence({
  ...
  validateP39ProducerArtifact(document);
