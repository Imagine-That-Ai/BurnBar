...
def main() -> None:
    ...
    if usage.exists() or usage.is_symlink() or usage.parent.resolve(strict=True) != database.parent.resolve(strict=True):
    ...
    foundation_seconds = datetime.now(timezone.utc).timestamp() - 978_307_200
    record = {
