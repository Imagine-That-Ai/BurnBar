import { P30_PROOF_ROLE, validateP30Proof } from "../lib/p30-pet-proof.mjs";
...
export async function validateProductRequirement(context) {
  ...
  const rows = validated.proofs.get(P30_PROOF_ROLE);
  if (!Array.isArray(rows) || rows.length !== 1)
    throw new Error(`${P30_PROOF_ROLE} proof must occur exactly once`);
