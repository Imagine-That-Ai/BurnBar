import { P26_PROOF_ROLE, validateP26Proof } from "../lib/p26-tray-proof.mjs";
...
export async function validateProductRequirement(context) {
  ...
  const rows = validated.proofs.get(P26_PROOF_ROLE);
  if (!Array.isArray(rows) || rows.length !== 1)
    throw new Error(`${P26_PROOF_ROLE} proof must occur exactly once`);
