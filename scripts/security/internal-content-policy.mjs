...
export const INTERNAL_RULES = [
  ...
  },
  {
    ...
    paths: [
      ...
      /^docs\/security\/.*SECURITY_SCAN.*\.md$/i,
      /^docs\/security\/SCAN_RUN-.*\.md$/i,
      /^docs\/security\/OPENBURNBAR_REPO_THREAT_MODEL_.*\.md$/i,
      /^docs\/security\/SECURITY_AUDIT_RELEASE_HANDOFF_.*\.md$/i,
