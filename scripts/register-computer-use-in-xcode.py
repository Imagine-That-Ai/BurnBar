...
MAC_FILES = [
    ...
    "AgentLens/Services/ComputerUse/Mac/SmartZoomContextProvider.swift",
    "AgentLens/Services/ComputerUse/Mac/RemoteClipboardController.swift",
...
IOS_FILES = [
    "OpenBurnBarMobile/Services/Media/MercuryPeerSource+Mobile.swift",
