...
assert_equals "fresh-host count covers memory, projection, and isolated media tests" \
    "$((memory_activation_test_count + projection_test_count + 2))" \
