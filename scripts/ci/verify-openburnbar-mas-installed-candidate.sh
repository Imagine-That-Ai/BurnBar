...
# Verify one installed Mac App Store candidate and bind its store receipt to the
# exact App Store Connect processed-build receipt that authorized this check.
...
echo "PASS: installed Mac App Store OpenBurnBar is signature/profile checked and bound to exact processed-build and store-receipt evidence."
