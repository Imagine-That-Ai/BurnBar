...
def create_deletion_receipt(
    ...
    *,
    ...
    reviewed_commit = GATE.require_commit(repo_root, reviewed_commit, "reviewed deletion plan commit")
    GATE.require_ancestor(repo_root, reviewed_commit, commit, "reviewed deletion plan commit")
