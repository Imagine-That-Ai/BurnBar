...
# OpenBurnBarKernel resource bundle; stage it beside the OpenBurnBarCore bundle (which
# keeps the SVGs + Pretext HTML/JS) so the daemon's Bundle.module loaders resolve.
