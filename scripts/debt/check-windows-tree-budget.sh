...
#     pretext / computeruse / integrations / packaging / tests) is computed ONLY
#     from windows/<area>/, so growth in one area cannot move another area's
#     counter.
#
# Fails CI if EITHER:
...
#   - a Windows source file lives OUTSIDE the eleven documented sub-trees.
