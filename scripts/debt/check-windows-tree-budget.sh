...
#     computeruse / integrations / cloudsync / tests) is computed ONLY from
...
#   - a Windows source file lives OUTSIDE the ten documented sub-trees.
...
AREAS = ("app", "pal", "native", "storage", "particles", "pretext", "computeruse", "integrations", "cloudsync", "tests")
...
if stray:
    ...
    print(
        ...
        "windows/{app,pal,native,storage,particles,pretext,computeruse,integrations,cloudsync,tests}/ "
