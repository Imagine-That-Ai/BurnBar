...
#     integrations / tests) is computed ONLY from windows/<area>/, so growth in one
...
if stray:
    ...
    print(
        "Place Windows source under windows/{app,pal,native,storage,particles,pretext,integrations,tests}/ "
