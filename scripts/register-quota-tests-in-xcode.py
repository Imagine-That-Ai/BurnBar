...
def main() -> int:
    ...
    for path in TEST_FILES:
        ...
        existing_file_ref_id = find_existing_file_ref_id(contents, path, TESTS_SOURCES_PHASE)
        if existing_file_ref_id and source_phase_build_id_for_file_ref(contents, TESTS_SOURCES_PHASE, existing_file_ref_id):
