...
final class AppStoreReviewComplianceTests: XCTestCase {
    ...
    func testHostedQuotaStoreKeepsReviewVisibleProductsInLockstepWithAppStoreConnectCatalog() throws {
        ...
        XCTAssertTrue(source.contains("Every App Store-reviewable auto-renewable subscription and consumable"))
        XCTAssertFalse(source.contains("static let productID = \"com.openburnbar.hostedQuotaSync.cloud.monthly\""))
        ...
        XCTAssertTrue(source.contains("storeKitProduct.purchase(confirmIn: scene, options: options)"))
        ...
        XCTAssertTrue(source.contains("verifyCloudProTopUp"))
