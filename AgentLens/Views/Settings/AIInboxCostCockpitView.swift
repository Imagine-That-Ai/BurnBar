...
struct AIInboxCostCockpitView: View {
    ...
    struct ModelOption: Identifiable, Hashable, Sendable {
        ...
        var perActiveTick: Double {
            ...
            let input = 60_000 * inputPerMTok / 1_000_000
            let output = 4_000 * outputPerMTok / 1_000_000
            let cache = 0 // conservative; cache-hit prefix saves but we show worst-case
...
private struct AIInboxWhatIfBar: View {
    ...
    private var verifierCostPerTick: Double {
        ...
        let perCall = 8_000 * verifier.inputPerMTok / 1_000_000 + 300 * verifier.outputPerMTok / 1_000_000
        return perCall * 3
    }
