...
struct ConnectionsSettingsView: View {
    ...
    @State var externalAuthStates: [String: CLIAuthInfo] = [:]
    @State var refreshingExternalCredentialIDs: Set<String> = []
    @State var externalCredentialMessages: [String: String] = [:]
    ...
    func refreshExternalAuthStates() {
    ...
    func quotaWindows(for account: ProviderAccountDoc) -> [SwitcherQuotaWindowDisplay] {
    ...
    func quotaWindows(for account: ExternalOAuthAccount) -> [SwitcherQuotaWindowDisplay] {
