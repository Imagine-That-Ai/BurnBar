...
enum SettingsAnchor {
    ...
    static let useKernelBackdrop = "general.appearance.useKernelBackdrop"
    static let backdropKernel = "general.appearance.backdropKernel"
    ...
    static let visualSurface = "agents.visualSurface"
