// Wave 3.1: Lab-only (Core builds compile this TU to nothing; the sole
// lookup is the class-name string in Lab-guarded SceneKitPetRenderer).
#if OPENBURNBAR_LAB
