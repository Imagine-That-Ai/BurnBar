...
final class SceneKitPetRenderer: NSObject, PetRenderer {
    ...
    private static func clipCandidates(for logical: String) -> [String] {
        ...
        case "listen": return ["wave", "listen", "idle"]
        case "greeting": return ["wave", "listen", "idle"]
        case "think":  return ["clean", "scoop", "work", "idle"]
        case "speak":  return ["wave", "talk", "work", "idle"]
        ...
        case "react":  return ["cheer", "clap", "jump", "dance", "react", "idle"]
        case "success": return ["cheer", "clap", "jump", "dance", "react", "idle"]
        default:       return []
        }
    }
}
