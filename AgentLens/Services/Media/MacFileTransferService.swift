...
final class MacFileTransferService: ObservableObject {
    ...
    private static let maxAtRestSealPlaintextBytes = Int64(IrohBlobTransferLimits.maxExpectedFetchBytes)
    ...
    private func sealReceivedFileAtRest(
        ...
        defer { try? FileManager.default.removeItem(at: tempURL) } // try?-ok(best-effort temp seal cleanup)
