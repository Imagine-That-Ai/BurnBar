...
// MARK: - Migrations v41–v51a

/// Ordered migration registrations v41_reprice_openai_family_cached_input
/// through v51a_drop_body_fts, extracted verbatim from the canonical migrator.
/// Registration order is sacred: bodies and sequence must not change.
extension OpenBurnBarDatabase {
    static func registerMigrationsV41toV51(on migrator: inout DatabaseMigrator) {
