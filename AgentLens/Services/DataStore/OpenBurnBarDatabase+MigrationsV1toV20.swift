...
// MARK: - Migrations v1–v20

/// Ordered migration registrations v1_initial through v20_chat_threads,
/// extracted verbatim from the canonical migrator. Registration order is
/// sacred: bodies and sequence must not change.
extension OpenBurnBarDatabase {
    static func registerMigrationsV1toV20(on migrator: inout DatabaseMigrator) {
