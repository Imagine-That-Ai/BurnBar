/**
 * Iridescent Mesh kernel — slow Stripe/linear-style gradient mesh + grain.
 *
 * Four drifting color anchors blended by inverse-square weight (a soft
 * gradient mesh), a noise-driven hue shimmer for iridescence, and fine film
 * grain. The calmest, most theme-robust of the four kernels.
 */
...
export function createMeshKernel(): Kernel {
  return createShaderKernel({ id: "mesh", label: "Iridescent Mesh", body: BODY });
}
