...
object DataDomains {
    val all: List<DataDomain> = listOf(
        ...
        DataDomain(
            ...
            firestorePaths = listOf("conversations", "chat_threads", "mobile_assistant_chats", "cli_sessions", "cli_agent_mission_requests", "text_snippets", "rollback_requests", "approval_policies", "agent_identities", "subscription_topics", "ai_inbox_items", "ai_inbox_item_state", "burnbar_attachments", "mission_approval_answers", "mission_approval_ceilings"), storagePaths = listOf("burnbar_attachments/{id}"),
        ...
        DataDomain(
            ...
            firestorePaths = listOf("devices", "hermes_connections", "hermes_pairings", "hermes_relay_requests", "hermes_session_cache", "hermes_gateway_clients", "hermes_gateway_destinations", "hermes_gateway_events", "hermes_gateway_messages", "hermes_gateway_typing", "hermes_gateway_state", "hermes_gateway_attachments", "hermes_gateway_approvals", "pi_agent_connections", "pi_agent_pairings", "pi_agent_relay_requests", "iroh_pairing", "iroh_pairing_keys", "iroh_controller_route_challenges", "relay_sender_keys", "runtime_connection_preferences", "hermes_bodies", "war_wire_grants"), storagePaths = listOf("hermes_gateway_attachments/**"),
