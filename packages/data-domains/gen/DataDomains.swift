...
public enum DataDomains {
    public static let all: [DataDomain] = [
        ...
        DataDomain(
            ...
            firestorePaths: ["cloud_vault_state", "cloud_vault_key_wrappers", "cloud_vault_rotation_jobs", "cloud_vault_rotation_requirements", "escrow_devices", "escrow_public_keys", "signal_identity_public_keys", "escrow_grants", "escrow_envelopes", "escrow_audit_events", "account_recovery_methods", "roaming_profile"], storagePaths: [],
