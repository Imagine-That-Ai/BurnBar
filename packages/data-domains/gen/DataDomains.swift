...
public enum DataDomains {
    public static let all: [DataDomain] = [
        ...
        DataDomain(
            ...
            serverSees: ["cloaked 384-dim vectors", "sourceKind", "opaque keyed slug/dedup/source hashes", "opaque repo match token", "chunk/byte counts", "approved memory metadata", "forget receipt hashes", "timestamps"], deviceOnly: ["chunk text", "chat memory fact bodies", "chat memory citations", "source paths", "repo names", "section/category metadata"],
