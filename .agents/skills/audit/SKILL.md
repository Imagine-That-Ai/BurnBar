...
name: audit
description: |
  Post-implementation launch-readiness audit. Use after an implementation run,
  before shipping, or when asked to audit, prove it, stress-test this, review
  your own work, decide whether it is truly done, or reach the "holy shit,
  that's done" bar. Inspects correctness, architecture, UX, visual polish,
  state, edge cases, tests, docs, SOTA quality, and completeness; fixes reachable
  issues; reruns validators; and ends with a structured ship/hold report.
---
