...
class AndroidFileTransferServiceTest {
    ...
    fun advertise_emits_received_acknowledgment_on_success() = runBlocking {
        ...
        val manifest =
            HermesRealtimeRelayAttachmentManifest(
                ...
                mime = "text/plain",
                size = 7,
                // Swift synthesizes createdAt as a Date -> NUMBER of reference-seconds (800582400.0 == 2026-05-16T00:00:00Z).
                createdAt = 800_582_400.0,
            )
        val frame =
        ...
        val sender =
            AndroidFileTransferService.AdvertiseSender { capturedFrame ->
    ...
    fun disabled_flag_throws_setting_disabled_on_send() {
        ...
        val ex =
            assertThrows(AndroidFileTransferService.Failure.SettingDisabled::class.java) {
                runBlocking {
                    service.sendFile(
