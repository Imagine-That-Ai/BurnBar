    ...
    private fun InsightTimeWindow.toInterval(): Pair<String, String> {
        ...
        val start: java.time.Instant =
            when (this) {
                ...
                is InsightTimeWindow.Last24h -> now.minus(java.time.Duration.ofHours(VAL_24))
                is InsightTimeWindow.Last7d -> now.minus(java.time.Duration.ofDays(VAL_7))
                is InsightTimeWindow.Last30d -> now.minus(java.time.Duration.ofDays(VAL_30))
                is InsightTimeWindow.Last90d -> now.minus(java.time.Duration.ofDays(VAL_90))
                is InsightTimeWindow.Last365d -> now.minus(java.time.Duration.ofDays(VAL_365))
