...
class ComputerUseSecurityCallableClient(
    ...
    suspend fun beginBurnbarAttachment(byteCount: Long, contentBlake3: String, deviceId: String, transport: String = "cloud"): Map<*, *> =
    ...
    suspend fun mintBurnbarAttachmentPartURL(id: String, partIndex: Int, contentLength: Long, deviceId: String): String {
        val result =
            callHighRiskOwnerAction(
    ...
    suspend fun composeBurnbarAttachment(id: String, deviceId: String) {
        callHighRiskOwnerAction(
    ...
    suspend fun finalizeBurnbarAttachment(id: String, deviceId: String) {
        callHighRiskOwnerAction(
    ...
    suspend fun cancelCliAgentMission(requestId: String, deviceId: String, sealedStatePayload: Map<String, Any>) {
        callHighRiskOwnerAction(
    ...
    suspend fun redeemMissionApprovalAnswer(requestId: String, deviceId: String, ceilingDigest: String, requestedGrant: Map<String, Any>) {
        callHighRiskOwnerAction(
