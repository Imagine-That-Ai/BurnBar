...
sealed class InsightWidgetSpec {
    ...
    @Serializable enum class CompareWindow {
        ...
        @SerialName("weekOverWeek")
        WEEK_OVER_WEEK,

        @SerialName("monthOverMonth")
        MONTH_OVER_MONTH,

        @SerialName("yearOverYear")
        YEAR_OVER_YEAR,
    }
