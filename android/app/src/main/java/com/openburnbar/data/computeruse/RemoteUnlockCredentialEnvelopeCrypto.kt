...
object RemoteUnlockCredentialEnvelopeCrypto {
    ...
    fun seal(
        ...
        require(publicKeyBytes.size == 32) { "Remote Unlock recipient key must be 32 bytes" }
        ...
        val ciphertext = HpkeEncrypt.create(publicKey).encrypt(
...
internal fun HermesRealtimeRelayRemoteUnlockCredentialEnvelope.CredentialKind.wireValue(): String =
    when (this) {
