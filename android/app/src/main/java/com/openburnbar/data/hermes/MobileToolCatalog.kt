...
object MobileToolCatalog {
    ...
    fun grouped(): Map<MobileToolCategoryGroup, List<MobileTool>> = tools.groupBy { it.categoryGroup }
     ...
     */
    fun dispatchLocal(toolName: String, argumentsJson: String, navigator: HermesAtomNavigator?): Boolean {
        if (toolName != "burnbar_atom_open" || navigator == null) return false
