...
object DataDomains {
    val all: List<DataDomain> = listOf(
        ...
        DataDomain(
            ...
            encryptionTier = EncryptionTier.END_TO_END, summary = "Assistant chats, CLI agent transcripts, mobile mission prompts/results, saved text snippets, rollback scope/diagnostics, approval rules, agent personas, subscription graph edges, conversation recall metadata, and AI Inbox findings are sealed on-device before Firestore receives them. NOTE: your per-item AI Inbox state — read, archived, snoozed, and the useful/not-useful verdict — rides as plain status metadata so every device converges on the same inbox; the item title, body, and evidence stay sealed.",
            serverSees = listOf("provider/runtime identifiers", "message counts", "status/routing metadata", "timestamps", "device ids", "AI Inbox item kind/priority/lifecycle", "AI Inbox read, archive, snooze, and feedback verdicts"), deviceOnly = listOf("chat titles", "chat previews", "message bodies", "CLI transcripts", "mission prompts/results", "saved text snippets", "project/file/command labels", "rollback scope paths", "rollback error diagnostics", "approval policy labels/globs/projects", "agent persona text", "subscription graph edges and display text", "AI Inbox titles, summaries, and evidence"),
            firestorePaths = listOf("conversations", "chat_threads", "mobile_assistant_chats", "cli_sessions", "cli_agent_mission_requests", "text_snippets", "rollback_requests", "approval_policies", "agent_identities", "subscription_topics", "ai_inbox_items", "ai_inbox_item_state"), storagePaths = listOf(),
        ...
        DataDomain(
            ...
            serverSees = listOf("cloaked 384-dim vectors", "sourceKind", "opaque keyed slug/dedup/source hashes", "opaque repo and GitHub-installation match tokens", "chunk/byte counts", "approved memory metadata", "forget receipt hashes", "timestamps"), deviceOnly = listOf("chunk text", "chat memory fact bodies", "chat memory citations", "source paths", "repo names", "section/category metadata"),
            firestorePaths = listOf("cloud_search_knowledge", "knowledge_sync_manifests", "knowledge_repos", "memory_facts", "memory_forget_receipts"), storagePaths = listOf(),
        ...
        DataDomain(
            ...
            firestorePaths = listOf("devices", "hermes_connections", "hermes_pairings", "hermes_relay_requests", "hermes_session_cache", "hermes_gateway_clients", "hermes_gateway_destinations", "hermes_gateway_events", "hermes_gateway_messages", "hermes_gateway_typing", "hermes_gateway_state", "hermes_gateway_attachments", "hermes_gateway_approvals", "pi_agent_connections", "pi_agent_pairings", "pi_agent_relay_requests", "iroh_pairing", "iroh_pairing_keys", "iroh_controller_route_challenges", "relay_sender_keys", "runtime_connection_preferences"), storagePaths = listOf("hermes_gateway_attachments/**"),
        ...
        DataDomain(
            ...
            serverSees = listOf("session events", "quota usage", "attachment blob hash", "mime type", "byte size", "opaque peer device-id hash", "direction", "short-lived call routing ids", "timestamps"), deviceOnly = listOf("media payload contents (relayed/sealed)", "attachment file names (sealed on-device)"),
            firestorePaths = listOf("media_session_events", "media_quota_usage", "media_attachment_manifests", "incoming_call_contexts"), storagePaths = listOf(),
        ...
        DataDomain(
            ...
            encryptionTier = EncryptionTier.SERVER_READABLE, summary = "Your subscription entitlements (Cloud Pro, Ultra), prepaid Memory Boost token packs, and their change history.",
            serverSees = listOf("entitlement ids", "product ids", "active state", "expiry", "purchase source", "prepaid Memory Boost balances and grant metadata"), deviceOnly = listOf(),
            firestorePaths = listOf("entitlements", "entitlement_events", "entitlement_bindings", "billing", "memoryWallet", "memoryWalletLedger"), storagePaths = listOf(),
        ...
        DataDomain(
            ...
            firestorePaths = listOf("cloud_vault_state", "cloud_vault_key_wrappers", "cloud_vault_rotation_jobs", "cloud_vault_rotation_requirements", "escrow_devices", "escrow_public_keys", "signal_identity_public_keys", "escrow_grants", "escrow_envelopes", "escrow_audit_events", "account_recovery_methods", "roaming_profile", "linux_app_check_devices", "linux_app_check_challenges"), storagePaths = listOf(),
