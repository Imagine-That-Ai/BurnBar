...
sealed class InsightWidgetData {
    @Serializable data class KPI(
        ...
        val deltaIsPercent: Boolean = true,
    ...
    @Serializable data class Forecast(
        val actual: List<TimeSeries.Point>,
        val forecast: List<TimeSeries.Point>,
        val lowerBound: List<TimeSeries.Point>,
        val upperBound: List<TimeSeries.Point>,
        val xAxisLabel: String,
        val yAxisLabel: String,
        val yFormat: ValueFormat,
    ...
    @Serializable data class UseCaseCluster(val clusters: List<Cluster>) : InsightWidgetData() {
        @Serializable data class Cluster(
            val id: String,
            val label: String,
            val size: Int,
            val exampleSessionIDs: List<String> = emptyList(),
            val colorHex: String? = null,
        )
    }
