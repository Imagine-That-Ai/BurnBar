...
@Composable
internal fun MissionTileBody(tile: ActiveMission) {
    Column(
...
internal fun iconForPhase(phase: ActiveMission.Phase): ImageVector = when (phase) {
...
internal fun colorForPhase(phase: ActiveMission.Phase): Color = when (phase) {
