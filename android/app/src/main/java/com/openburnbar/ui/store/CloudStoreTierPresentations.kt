...
internal fun cloudTierPresentation(): TierPlanPresentation = TierPlanPresentation(
    label = "Cloud",
    title = "BurnBar Cloud",
...
internal fun cloudProTierPresentation(): TierPlanPresentation = TierPlanPresentation(
    label = "Cloud Pro",
...
internal fun cloudUltraTierPresentation(): TierPlanPresentation = TierPlanPresentation(
    label = "Cloud Ultra",
