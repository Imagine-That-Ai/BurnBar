    ...
    private val baseItems: List<SettingsItem> =
        listOf(
            ...
            SettingsItem(
                ...
                helpText = "Android mirrors the Mac stream and can signal a panic halt. Approving or rejecting individual agent actions and trust changes is confirmed on the Mac; over-the-wire approval from Android is not yet enabled.",
            ),
            SettingsItem(
