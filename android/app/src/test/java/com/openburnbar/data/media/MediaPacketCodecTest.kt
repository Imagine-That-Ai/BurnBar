...
class MediaPacketCodecTest {
    ...
    fun round_trip_preserves_header_and_payload() {
        ...
        val frame =
            MediaFrame(
                ...
                payload = byteArrayOf(MILLIS, MILLIS_2, MILLIS_3, MILLIS_4),
            )
    ...
    fun round_trip_preserves_computer_use_cursor_metadata() {
        ...
        assertEquals(MediaFrame.CursorMetadata(VAL_320, VAL_180), decoded.cursor)
    }
    ...
    fun custom_payload_ceiling_allows_chunkable_mirror_frames() {
        ...
        val source =
            MediaFrame(
                ...
                payload = ByteArray(MediaPacketCodec.DEFAULT_MAX_PAYLOAD_BYTES + VAL_64 * MILLIS_5) { MILLIS_6 },
            )
    ...
    fun v1_decoder_treats_unknown_metadata_bit_as_payload_without_negotiation() {
        val codec = MediaPacketCodec()
        val metadataBytes = byteArrayOf(0x00, 0x00, 0x00, 0x02, VAL_0X21, 0x00)
        val samplePayload = byteArrayOf(MILLIS_6, VAL_0X7B)
