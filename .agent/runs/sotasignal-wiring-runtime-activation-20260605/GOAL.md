...
- [done] On-device Android instrumented proof PASSED (Galaxy SM-S921U). [blocked] Apple on-device proof (devices offline; Codex item 1) + Item 5 LIVE ring rollout/rollback — activation-time, owner-gated, "do not flip" per directive; surfaced to user via AskUserQuestion.
