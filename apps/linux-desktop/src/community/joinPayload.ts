...
import type { ConsentTriState } from "./consentStore.js";
import { cityKeyFromManualCityInput } from './geoCityKey.js';
...
/** Wire shape for `joinCommunity` / `updateCommunityProfile` callables. */
export type CommunityJoinWire = Record<string, string>;

export function buildJoinCommunityWire(
  ...
  const payload: CommunityJoinWire = {
