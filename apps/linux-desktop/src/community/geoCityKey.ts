/**
 * Ports functions/src/community/geo.ts city key canonicalization + deriveGeoKeys for manual picker.
 */
...
/** Manual city label + device timezone/locale → canonical cityKey for join payload. */
