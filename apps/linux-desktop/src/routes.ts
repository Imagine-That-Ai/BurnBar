...
export const ROUTES: RouteMeta[] = [
  ...
  { id: 'computer-use', label: 'Computer Use', group: 'system', description: 'Linux capture, input, audit, media, and mobile control readiness.' },
...
export function routeFromHash(hash: string): ShellRoute {
  const raw = hash.replace(/^#\/?/, '').trim() || 'overview';
