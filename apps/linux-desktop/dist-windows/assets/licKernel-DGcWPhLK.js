...
const float TILE_PX     = ${t.toFixed(1)};   // blue-noise tile edge (matches bake)
...
`;function o(){return e({id:"lic",label:"Flow Imaging",body:l,textures:[{name:"uBlueNoise",dataUri:i,filter:"linear",wrap:"repeat"}],controls:["scroll"]})}export{o as createLicKernel};
