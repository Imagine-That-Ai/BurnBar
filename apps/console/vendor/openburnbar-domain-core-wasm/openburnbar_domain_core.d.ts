...
export function pensieveDeterministicEmbed(text: string, dimensions: number, is_query: boolean): Float64Array;
...
export function pensieveDeterministicEmbedAndCloak(text: string, dimensions: number, is_query: boolean, vault_key: Uint8Array, model_version: string): Float64Array;
...
export function pensieveVectorCloak(vector: Float64Array, vault_key: Uint8Array, model_version: string): Float64Array;
...
export function pensieveL2Normalize(vector: Float64Array): Float64Array;
...
export interface InitOutput {
  ...
  readonly cloudVaultPensieveDedupHash: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly cloudVaultPensieveProvenanceHash: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly cloudVaultPensieveSlugHmac: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly cloudVaultProjectMemoryDocId: (a: number, b: number, c: number, d: number, e: number) => void;
  ...
  readonly cloudVaultSubscriptionDocId: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
  ...
  readonly pensieveDeterministicEmbed: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly pensieveDeterministicEmbedAndCloak: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => void;
  readonly pensieveL2Normalize: (a: number, b: number, c: number) => void;
  readonly pensieveVectorCloak: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
