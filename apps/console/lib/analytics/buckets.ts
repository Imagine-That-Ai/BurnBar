/**
 * Anti-fingerprinting bucketing. Raw counts/durations/amounts/sizes are never
 * sent; they map to coarse, canonical buckets identical on every platform.
 * Boundaries are ported verbatim from
