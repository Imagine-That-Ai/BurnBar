/**
 * Paperfield kernel — "Origami" backdrop: a warm hand-made kozo paper sheet.
 *
 * A procedural washi/kozo paper field: a domain-warped fbm drives the long
 * kozo-fiber grain, slow-moving laid lines (the wire screen imprint) undulate
 * across the sheet, a deckle-edge vignette frames the page, and a faint warm
 * bloom breathes where the page catches an off-canvas window light. Pointer
 * stirs the laid-line phase (paper flexing); scroll drifts the grain.
 *
 * The read is unmistakably a hand-made paper sheet — the quiet, fibrous stage
 * on which origami/kirigami/sumi/quilling marks live. Dark theme: a deep warm
 * ink-wash washi under moonlight; light theme: bright cream kozo in window
 * light.
 *
...
export function createPaperfieldKernel(): Kernel {
