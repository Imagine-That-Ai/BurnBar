...
vi.mock("@/lib/useDomainUsage", () => ({
  useDomainUsage: () => ({
    data: {
      ok: true,
      tier: "pro",
      limits: { pensieve: { sources: 0, chunks: 0, bytes: 0 } },
      domains: [],
      schemaVersion: 1,
    },
    loading: false,
...
<style>
  ...
  body { font-family: var(--font-body); color: var(--color-text-base); margin: 0 auto; max-width: 72rem; padding: var(--space-12) var(--space-6); }
