...
import { detectGlCapabilities, NO_FLOAT_CAPS } from "@openburnbar/gl-engine/gl/glCapabilities";
import { resolvePalette, toCss } from "@openburnbar/gl-engine/palette";
import { getKernelDescriptor } from "@openburnbar/gl-engine/registry";
import type { Kernel, KernelFrameContext, KernelId } from "@openburnbar/gl-engine/types";
