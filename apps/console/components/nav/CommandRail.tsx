...
function Brand() {
  return (
    <Link href="/" className="flex items-center gap-2 px-1">
      {/* The flame mark is full-colour, so it reads on every theme; the tile
          behind it is token-driven (elevated surface + hairline), which is
          what makes the lockup theme-context-sensitive. */}
      <span
        className="grid size-6 shrink-0 place-items-center rounded-md border border-glass-line"
        style={{ background: "var(--color-ink-elevated)" }}
      >
        <img src="/brand/burnbar-logo-mark.png" alt="" className="size-4 object-contain" />
      </span>
